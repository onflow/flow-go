...
require (
	...
	github.com/onflow/flow-core-contracts/lib/go/contracts v0.8.1-0.20220104205806-8dbe78a71b77
	github.com/onflow/flow-core-contracts/lib/go/templates v0.8.1-0.20220104205806-8dbe78a71b77
