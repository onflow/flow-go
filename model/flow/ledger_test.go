...
func TestRegisterID_IsInternalState(t *testing.T) {
	...
	requireFalse(unittest.RandomAddressFixture(), "public_key_12")
	requireTrue(unittest.RandomAddressFixture(), "apk_0")
	requireTrue(unittest.RandomAddressFixture(), "pk_b0")
	requireTrue(unittest.RandomAddressFixture(), "sn_0")
