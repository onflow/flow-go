...
type ClusterList []flow.IdentityList
...
func (cl ClusterList) Get(id ClusterID) flow.IdentityList {
...
func (cl ClusterList) ClusterIDFor(nodeID flow.Identifier) ClusterID {
