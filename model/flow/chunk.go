...
type ChunkBody struct {
	...
	EventCollection Fingerprint     // Events generated by executing results
...
func (ch *Chunk) Fingerprint() Fingerprint {
	return Fingerprint(hash.DefaultHasher.ComputeHash(encoding.DefaultEncoder.MustEncode(ch)))
}
