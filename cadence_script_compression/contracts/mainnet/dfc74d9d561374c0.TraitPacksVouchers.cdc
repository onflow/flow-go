/*
    A NFT contract which is redeemable for a Traits Pack.
...
pub contract TraitPacksVouchers: NonFungibleToken {
    // -----------------------------------------------------------------------
    ...
    pub resource NFT : NonFungibleToken.INFT {
        ...
        pub fun getMetadata(): {String: String} {
            if (TraitPacksVouchers.idToVoucherMetadata[self.id] != nil) {
                return TraitPacksVouchers.idToVoucherMetadata[self.id]!.metadata
            } else {
                return {}
            }
        }
    ...
    pub resource interface PackVoucherCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowVoucher(id: UInt64): &TraitPacksVouchers.NFT? {
            post {
    ...
    pub resource Collection: NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, PackVoucherCollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            let token <- token as! @TraitPacksVouchers.NFT
        ...
        pub fun borrowVoucher(id: UInt64): &TraitPacksVouchers.NFT? {
            if self.ownedNFTs[id] != nil {
                ...
                return ref as! &TraitPacksVouchers.NFT
            } else {
                return nil
            }
        }
    ...
    init() {
        self.name = "Goated Goats Trait Packs Vouchers"
        self.totalSupply = 0
        ...
        self.CollectionStoragePath = /storage/GoatTraitsPackVoucherCollection
        self.CollectionPublicPath = /public/GoatTraitsPackVoucherCollection
