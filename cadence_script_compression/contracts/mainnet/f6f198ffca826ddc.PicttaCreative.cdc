...
pub contract PicttaCreative: NonFungibleToken {

    // -----------------------------------------------------------------------
    // PicttaCreative contract Events
    // -----------------------------------------------------------------------

    // Emitted when the PicttaCreative contract is created
    ...
    // -----------------------------------------------------------------------
    // PicttaCreative contract-level fields.
    ...
    // -----------------------------------------------------------------------
    // PicttaCreative contract-level Composite Type definitions
    // -----------------------------------------------------------------------
    ...
    pub struct Item {
        ...
        init(metadata: {String: String}) {
            ...
            self.itemId = PicttaCreative.nextItemId
            self.metadata = metadata

            // Increment the Id so that it isn't used again
            PicttaCreative.nextItemId = PicttaCreative.nextItemId + UInt32(1)
    ...
    pub struct SetData {
        ...
        init(name: String, description: String?) {
            ...
            self.setId = PicttaCreative.nextSetId
            self.name = name
            self.description = description
            self.series = PicttaCreative.currentSeries

            // Increment the setId so that it isn't used again
            PicttaCreative.nextSetId = PicttaCreative.nextSetId + UInt32(1)
    ...
    pub resource Set {
        ...
        access(contract) var numberMintedPerItem: {UInt32: UInt32}
        ...
        init(name: String, description: String?) {
            ...
            PicttaCreative.setDatas[self.setId] = SetData(name: name, description: description)
        }
        ...
        pub fun addItem(itemId: UInt32) {
            pre {
                PicttaCreative.itemDatas[itemId] != nil: "Cannot add the Item to Set: Item doesn't exist."
    ...
    pub resource NFT: NonFungibleToken.INFT {
        ...
        init(serialNumber: UInt32, itemId: UInt32, setId: UInt32) {
            ...
            PicttaCreative.totalSupply = PicttaCreative.totalSupply + UInt64(1)

            self.id = PicttaCreative.totalSupply
    ...
    pub resource Admin {
        ...
        pub fun createItem(metadata: {String: String}): UInt32 {
            ...
            PicttaCreative.itemDatas[newId] = newItem
        ...
        pub fun borrowSet(setId: UInt32): &Set {
            pre {
                PicttaCreative.sets[setId] != nil: "Cannot borrow set: The set doesn't exist."
            }

            return &PicttaCreative.sets[setId] as &Set
        }
        ...
        pub fun startNewSeries(): UInt32 {
            ...
            return PicttaCreative.currentSeries
        }
    ...
    // Interface that users can cast their PicttaCreative Collection as
    // to allow others to deposit PicttaCreative Collectibles into their Collection.
    pub resource interface PicttaCreativeCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun batchDeposit(tokens: @NonFungibleToken.Collection)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowCollectible(id: UInt64): &PicttaCreative.NFT? {
    ...
    pub resource Collection: PicttaCreativeCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic {
        ...
        pub fun deposit(token: @NonFungibleToken.NFT) {
            ...
            let token <- token as! @PicttaCreative.NFT
        ...
        pub fun borrowCollectible(id: UInt64): &PicttaCreative.NFT? {
            if self.ownedNFTs[id] != nil {
                ...
                return ref as! &PicttaCreative.NFT
            } else {
                return nil
            }
        }
    ...
    // -----------------------------------------------------------------------
    // PicttaCreative contract-level function definitions
    // -----------------------------------------------------------------------
    ...
    pub fun createEmptyCollection(): @NonFungibleToken.Collection {
        return <-create PicttaCreative.Collection()
    }
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &PicttaCreative.NFT? {
        let collection = getAccount(from)
            .getCapability(PicttaCreative.CollectionPublicPath)!
            .borrow<&PicttaCreative.Collection{PicttaCreative.PicttaCreativeCollectionPublic}>()
    ...
    pub fun getAllItems(): [PicttaCreative.Item] {
    ...
    pub fun getSet(setId: UInt32): SetData? {
    ...
    pub fun isEditionRetired(setId: UInt32, itemId: UInt32): Bool? {
        if let setToRead <- PicttaCreative.sets.remove(key: setId) {
            ...
            PicttaCreative.sets[setId] <-! setToRead
            return retired
        } else {
            return nil
        }
    ...
    // -----------------------------------------------------------------------
    // PicttaCreative initialization function
    // -----------------------------------------------------------------------
    ...
    init() {
        ...
        self.CollectionStoragePath = /storage/PicttaCreativeCollection
        self.CollectionPublicPath = /public/PicttaCreativeCollection
        self.AdminStoragePath = /storage/PicttaCreativeAdmin

        // Put a new Collection in storage
        self.account.save<@Collection>(<- create Collection(), to: self.CollectionStoragePath)

        // Create a public capability for the Collection
        self.account.link<&{PicttaCreativeCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
