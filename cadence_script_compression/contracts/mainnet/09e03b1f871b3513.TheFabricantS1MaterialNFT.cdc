/*
    Description: TheFabricantS1MaterialNFT Contract
   
    TheFabricantS1MaterialNFT NFTs are minted by admins, and can be combined with 
...
pub contract TheFabricantS1MaterialNFT: NonFungibleToken {
    ...
    // -----------------------------------------------------------------------
    // TheFabricantS1MaterialNFT contract Events
    // -----------------------------------------------------------------------
    ...
    pub struct MaterialData {
        ...
        init(
            ...
            self.materialDataID = TheFabricantS1MaterialNFT.nextMaterialDataID
            self.designerAddress = designerAddress
            self.metadata = metadata
            self.royalty = royalty

            TheFabricantS1MaterialNFT.isMaterialDataRetired[self.materialDataID] = false

            // Increment the ID so that it isn't used again
            TheFabricantS1MaterialNFT.nextMaterialDataID = TheFabricantS1MaterialNFT.nextMaterialDataID + 1 as UInt32
    ...
    pub struct Material {
        ...
        init(materialDataID: UInt32) {
            ...
            // Increment the ID so that it isn't used again
            TheFabricantS1MaterialNFT.numberMintedPerMaterial[materialDataID] = TheFabricantS1MaterialNFT.numberMintedPerMaterial[materialDataID]! + 1 as UInt32

            self.serialNumber = TheFabricantS1MaterialNFT.numberMintedPerMaterial[materialDataID]!
        }
    }    
    ...
    pub fun getMaterialDatasRetired(): {UInt32: Bool} { 
        return TheFabricantS1MaterialNFT.isMaterialDataRetired
    }

    pub fun getMaterialDataRetired(materialDataID: UInt32): Bool { 
        let isMaterialDataRetired = TheFabricantS1MaterialNFT.isMaterialDataRetired[materialDataID]??
            panic("materialDataID not found")
    ...
    init() {
        ...
        self.totalSupply = 0
        self.CollectionPublicPath = /public/S1MaterialCollection0019
        self.CollectionStoragePath = /storage/S1MaterialCollection0019
        self.AdminStoragePath = /storage/S1MaterialAdmin0019
