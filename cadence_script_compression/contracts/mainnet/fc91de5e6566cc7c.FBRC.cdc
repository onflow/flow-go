...
pub contract FBRC: FungibleToken {
    ...
    init() {
        ...
        self.CollectionStoragePath = /storage/FbrcVault20
        self.CollectionReceiverPath = /public/FbrcReceiver20
        self.CollectionBalancePath = /public/FbrcBalance20
        self.AdminStoragePath = /storage/FbrcAdmin20
