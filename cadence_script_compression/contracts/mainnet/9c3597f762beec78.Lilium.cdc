...
pub contract Lilium: FungibleToken {
    ...
    /// Total supply of Liliums in existence
    pub var totalSupply: UFix64

    // Maximun Lilium supply
    ...
    pub resource Administrator {
        ...
        pub fun createNewMinter(allowedAmount: UFix64): @Minter {
            pre {
                Lilium.totalSupply < Lilium.maxSupply: "Max supply reached"
            }
    ...
    pub resource Minter {
        ...
        pub fun mintTokens(amount: UFix64): @Lilium.Vault {
            pre {
                ...
                amount + Lilium.totalSupply <= Lilium.maxSupply: "Amount minted must not surpass the max supply"
            }
