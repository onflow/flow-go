/// Canonical ceWETH on Flow
import FungibleToken from 0xf233dcee88fe0abe
import FTMinterBurner from 0x08dd120226ec2213

pub contract ceWETH: FungibleToken, FTMinterBurner {
    ...
    pub resource Vault: FungibleToken.Provider, FungibleToken.Receiver, FungibleToken.Balance {
        ...
        pub fun deposit(from: @FungibleToken.Vault) {
            let vault <- from as! @ceWETH.Vault
    ...
    pub resource Minter: FTMinterBurner.IMinter {
        ...
        pub fun mintTokens(amount: UFix64): @FungibleToken.Vault {
            ...
            ceWETH.totalSupply = ceWETH.totalSupply + amount
    ...
    init() {
        ...
        self.AdminPath = /storage/ceWETHAdmin
