...
pub contract S1MaterialNFT: NonFungibleToken {
    ...
    pub resource Admin {
        ...
        pub fun mintNFT(materialDataID: UInt32): @NFT {
            let numInMaterial = S1MaterialNFT.numberMintedPerMaterial[materialDataID]??
        ...
        pub fun retireMaterialData(materialDataID: UInt32) {           
            pre {
                S1MaterialNFT.isMaterialDataRetired[materialDataID] != nil: "Cannot retire Material: Material doesn't exist!"
            }
    ...
    pub resource interface MaterialCollectionPublic {
        ...
        pub fun borrowMaterial(id: UInt64): &S1MaterialNFT.NFT? {
    ...
    pub fun getMaterialNumberMinted(id: UInt32): UInt32 {
        let numberMinted = S1MaterialNFT.numberMintedPerMaterial[id]??
    ...
    pub fun getMaterialData(id: UInt32): MaterialData {
        let materialData = S1MaterialNFT.materialDatas[id]??
            panic("materialDataID not found")
        return materialData
    }
    ...
    pub fun getMaterialDataRetired(materialDataID: UInt32): Bool { 
        let isMaterialDataRetired = S1MaterialNFT.isMaterialDataRetired[materialDataID]??
            panic("materialDataID not found")
