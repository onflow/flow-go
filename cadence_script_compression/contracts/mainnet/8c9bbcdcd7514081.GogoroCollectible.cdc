...
pub contract GogoroCollectible: NonFungibleToken {
    ...
    pub resource Admin {
        ...
        pub fun registerMetadata(itemID: UInt64, metadata: Metadata) {
            pre {
                GogoroCollectible.itemMetadata[itemID] == nil: "duplicated itemID"
            }
        ...
        pub fun updateMetadata(itemID: UInt64, metadata: Metadata) {
            pre {
                GogoroCollectible.itemMetadata[itemID] != nil: "itemID does not exist"
            }
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &GogoroCollectible.NFT? {
        let collection = getAccount(from)
            .getCapability(GogoroCollectible.CollectionPublicPath)!
            .borrow<&GogoroCollectible.Collection>()
