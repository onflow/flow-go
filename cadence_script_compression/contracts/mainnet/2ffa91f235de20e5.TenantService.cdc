...
pub contract TenantService: NonFungibleToken {
    ...
    init() {
        self.version = 1
        self.id = "gt6oeAcYKx"
        self.name = "Example Tenant"
        self.description = "An example Tenant"
        self.closed = false
        ...
        self.ADMIN_OBJECT_PATH = /storage/TenantAdmin_gt6oeAcYKx
        self.PRIVATE_NFT_COLLECTION_PATH = /storage/TenantNFTCollection_gt6oeAcYKx
        self.PUBLIC_NFT_COLLECTION_PATH = /public/TenantNFTCollection_gt6oeAcYKx
