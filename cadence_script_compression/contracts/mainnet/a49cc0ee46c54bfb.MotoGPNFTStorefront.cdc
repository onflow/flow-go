...
pub contract MotoGPNFTStorefront {
    ...
    // The price and ftVaultType fields are added to help the front end display purchase info without user being able to alert it via url
    //
    pub event SaleOfferCompleted(
        saleOfferResourceID: UInt64, 
    ...
    // SaleOfferRemoved
    // Not part of Dapper Lab's contract. Added by Animoca
    //
    pub event SaleOfferRemoved(saleOfferResourceID: UInt64);
    ...
    access(contract) var commissionReceiverMap: {String : Capability<&{FungibleToken.Receiver}>}

    pub fun getCommissionRate() : UFix64 {
        return self.commissionRate
    }

    pub fun isCommissionReceiverSet(typeIdentifier: String) : Bool {
    ...
    pub resource SaleOffer: SaleOfferPublic {
        ...
        init (
            ...
            nftID: UInt64,
            salePaymentVaultType: Type,
            price: UFix64, // GK: pass in price UFix64,
            ...
            let saleCuts = [commissionCut, sellerPayoutCut]
        ...
        //
         pub fun createSaleOffer(
            ...
            let saleOffer <- create SaleOffer(
                ...
                salePaymentVaultType: salePaymentVaultType,
                price: price,
                sellerReceiver: sellerReceiver, // GK: use internal
    ...
    pub fun setCommissionReceiver(adminRef: &MotoGPAdmin.Admin, vaultType:Type, commissionReceiver: Capability<&{FungibleToken.Receiver}>){
        pre {
            adminRef != nil : "adminRef is nil"
