...
pub contract toddmain2_NFT: NonFungibleToken {

    // toddmain2_NFT Events
    //
    // Emitted when the toddmain2_NFT contract is created
    ...
    // totalSupply
    // The total number of toddmain2_NFT that have been minted
    //
    ...
    // A Series is special resource type that contains functions to mint toddmain2_NFT NFTs, 
	...
	pub resource Series {
        ...
        init(
            ...
            toddmain2_NFT.seriesData[seriesId] = SeriesData(
                    seriesId: seriesId,
                    metadata: metadata
            )      
        }
        ...
        pub fun addNftSet(
            ...
            toddmain2_NFT.setData[setId] = newNFTSet
        ...
        pub fun updateSeriesMetadata(metadata: {String: String}) {
            ...
            toddmain2_NFT.seriesData[self.seriesId] = newSeriesMetadata
        ...
        pub fun updateSetMetadata(
            ...
            toddmain2_NFT.setData[setId] = newSetMetadata
	    ...
	    pub fun minttoddmain2_NFT(
            ...
            pre {
                ...
                self.numberEditionsMintedPerSet[setId]! <= toddmain2_NFT.getSetMaxEditions(setId: setId)!:
			...
			recipient.deposit(token: <-create toddmain2_NFT.NFT(
                tokenId: tokenId,
                setId: setId,
            ...
            toddmain2_NFT.totalSupply = toddmain2_NFT.totalSupply + (1 as UInt64)
		...
		pub fun batchMinttoddmain2_NFT(
            recipient: &{NonFungibleToken.CollectionPublic},
            setId: UInt32,
            tokenIds: [UInt64]) {
    ...
    // A resource that represents the toddmain2_NFT NFT
    //
    pub resource NFT: NonFungibleToken.INFT {
        ...
        init(
          ...
          editionNum: UInt32) {
            ...
            let seriesId = toddmain2_NFT.getSetSeriesId(setId: setId)!
    ...
    pub resource Admin {
        ...
        pub fun borrowSeries(seriesId: UInt32): &Series  {
            ...
            return &toddmain2_NFT.series[seriesId] as &Series
        }
    ...
    // to allow others to deposit toddmain2_NFT into their Collection. It also allows for reading
    // the details of toddmain2_NFT in the Collection.
    pub resource interface toddmain2_NFTCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun batchDeposit(tokens: @NonFungibleToken.Collection)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowtoddmain2_NFT(id: UInt64): &toddmain2_NFT.NFT? {
            // If the result isn't nil, the id of the returned reference
            // should be the same as the argument to the function
            post {
                (result == nil) || (result?.id == id):
                    "Cannot borrow toddmain2_NFT reference: The ID of the returned reference is incorrect"
            }
        }
    }

    // Collection
    // A collection of toddmain2_NFT NFTs owned by an account
    //
    pub resource Collection: toddmain2_NFTCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic {
        ...
        // borrowtoddmain2_NFT
        // Gets a reference to an NFT in the collection as a toddmain2_NFT,
        ...
        pub fun borrowtoddmain2_NFT(id: UInt64): &toddmain2_NFT.NFT? {
            if self.ownedNFTs[id] != nil {
                ...
                return ref as! &toddmain2_NFT.NFT
            } else {
                return nil
            }
        }
    ...
    // fetch
    // Get a reference to a toddmain2_NFT from an account's Collection, if available.
    // If an account does not have a toddmain2_NFT.Collection, panic.
    ...
    //
    pub fun fetch(_ from: Address, id: UInt64): &toddmain2_NFT.NFT? {
        let collection = getAccount(from)
            .getCapability(toddmain2_NFT.CollectionPublicPath)
            .borrow<&toddmain2_NFT.Collection{toddmain2_NFT.toddmain2_NFTCollectionPublic}>()
            ?? panic("Couldn't get collection")
        // We trust toddmain2_NFT.Collection.borrowtoddmain2_NFT to get the correct id
        // (it checks it before returning it).
        return collection.borrowtoddmain2_NFT(id: id)
    }

    // getAllSeries returns all the sets
    //
    // Returns: An array of all the series that have been created
    pub fun getAllSeries(): [toddmain2_NFT.SeriesData] {
    ...
    pub fun getAllSets(): [toddmain2_NFT.NFTSetData] {
	...
	init() {
        // Set named paths
        self.CollectionStoragePath = /storage/toddmain2_NFTCollection
        self.CollectionPublicPath = /public/toddmain2_NFTCollection
        self.AdminStoragePath = /storage/toddmain2_NFTAdmin
        self.AdminPrivatePath = /private/toddmain2_NFTAdminUpgrade
        ...
        self.account.link<&toddmain2_NFT.Admin>(
