...
pub contract TheFabricantS1GarmentNFT: NonFungibleToken {
    ...
    init() {
        ...
        self.totalSupply = 0
        self.CollectionPublicPath = /public/S1GarmentCollection0019
        self.CollectionStoragePath = /storage/S1GarmentCollection0019
        self.AdminStoragePath = /storage/S1GarmentAdmin0019
