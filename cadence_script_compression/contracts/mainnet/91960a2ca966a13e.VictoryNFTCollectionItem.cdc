...
//
pub contract VictoryNFTCollectionItem: NonFungibleToken {
    ...
    pub event Minted(id: UInt64, typeID: UInt64, brandID: UInt64, dropID: UInt64)
	...
	pub resource NFTMinter {
                        ...
                        totalIssueNum: UInt32) 
        {
            ...
            while i < maxIssueNum {
                ...
                recipient.deposit(token: <-create VictoryNFTCollectionItem.NFT(initOwner:owner,
                                                                initID: VictoryNFTCollectionItem.totalSupply, 
                                                                initTypeID: typeID, 
                                                                initBrandID: brandID,
                                                                initDropID: dropID,
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &VictoryNFTCollectionItem.NFT? {
        let collection = getAccount(from)
            .getCapability(VictoryNFTCollectionItem.CollectionPublicPath)!
            .borrow<&VictoryNFTCollectionItem.Collection{VictoryNFTCollectionItem.VictoryNFTCollectionItemCollectionPublic}>()
