...
pub contract MyToken: FungibleToken {
    ...
    // Total supply of My token in existence
    ...
    //
    pub fun createEmptyVault(): @MyToken.Vault {
    ...
    init() {
        ...
        self.MinterProxyPublicPath = /public/MyTokenMinterProxy
        self.MinterProxyStoragePath = /storage/MyTokenMinterProxy
