...
import (
	...
	"github.com/dapperlabs/flow-go/pkg/module/filter"
...
type Engine struct {
	...
	cache   *ristretto.Cache // holds volatile information on collection exchange
...
func NewEngine(log zerolog.Logger, net module.Network, com module.Committee, pool module.Mempool) (*Engine, error) {

	// initialize the ristretto cache; it will hold volatile state about who we
	// are exchanging snapshots and mempools with
	...
	e.con, err = net.Register(CirculatorEngine, e)
	if err != nil {
