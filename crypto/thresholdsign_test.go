...
func GenDKGKeys(t *testing.T, n int) ([]PrivateKey, PublicKey, []PublicKey, []testDKGProcessor) {
	lead := 0
	...
	return privateKeys, groupKey, publicKeyShares, processors
}
...
func testThresholdSignatureJointFeldman(t *testing.T) {
	...
	_, _, _, processors := GenDKGKeys(t, n)
