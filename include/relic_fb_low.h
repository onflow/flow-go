...
/**
 * Adds two digit vectors of the same with, with this size different than the
 * standard precision. Computes c = a + b.
 *
 * @param[out] c			- the result.
 * @param[in] a				- the first digit vector to add.
 * @param[in] b				- the second digit vector to add.
...
/**
 * Multiplies two digit vectors of the same size modulo with embedded modular
 * reduction.
 *
 * @param[out] c			- the result.
 * @param[in] t				- the double-precision additional memory.
 * @param[in] a				- the first digit vector to multiply.
 * @param[in] b				- the second digit vector to multiply.
 */
...
/**
 * Reduces a digit vector modulo a trinomial or pentanomial.
 *
 * @param[out] c			- the result.
