...
func main() {
	...
	nodeInfo, err := loadPrivateNodeInfo(*privKeyFile)
	if err != nil {
...
func loadPrivateNodeInfo(privNodeInfo string) (*bootstrap.NodeInfoPriv, error) {
	data, err := io.ReadFile(privNodeInfo)
	if err != nil {
		return nil, err
	}
