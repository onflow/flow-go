...
func (exeConf *ExecutionConfig) SetupFlags(flags *pflag.FlagSet) {
	...
	flags.BoolVar(&exeConf.scheduledTransactionsEnabled, "scheduled-transactions-enabled", fvm.DefaultScheduledTransactionsEnabled, "enable execution of scheduled transactions")
