...
// NewGetStateCommitmentFunc creates a new instance of GetStateCommitmentFunc. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewGetStateCommitmentFunc(t testing.TB) *GetStateCommitmentFunc {
