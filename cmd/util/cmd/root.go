...
import (
	...
	rollback_collection_sync_indexed_height "github.com/onflow/flow-go/cmd/util/cmd/rollback-collection-sync-indexed-height/cmd"
...
func addCommands() {
	...
	rootCmd.AddCommand(rollback_collection_sync_indexed_height.Cmd)
