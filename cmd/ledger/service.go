...
// LedgerService implements the gRPC LedgerService interface
...
func NewLedgerService(l ledger.Ledger, logger zerolog.Logger) *LedgerService {
...
func (s *LedgerService) InitialState(ctx context.Context, req *emptypb.Empty) (*ledgerpb.StateResponse, error) {
...
func (s *LedgerService) HasState(ctx context.Context, req *ledgerpb.StateRequest) (*ledgerpb.HasStateResponse, error) {
...
func (s *LedgerService) GetSingleValue(ctx context.Context, req *ledgerpb.GetSingleValueRequest) (*ledgerpb.ValueResponse, error) {
	if req.State == nil || len(req.State.Hash) != len(ledger.State{}) {
		return nil, status.Error(codes.InvalidArgument, "invalid state")
	}
...
func (s *LedgerService) Get(ctx context.Context, req *ledgerpb.GetRequest) (*ledgerpb.GetResponse, error) {
	if req.State == nil || len(req.State.Hash) != len(ledger.State{}) {
		return nil, status.Error(codes.InvalidArgument, "invalid state")
	}
...
func (s *LedgerService) Set(ctx context.Context, req *ledgerpb.SetRequest) (*ledgerpb.SetResponse, error) {
	if req.State == nil || len(req.State.Hash) != len(ledger.State{}) {
		return nil, status.Error(codes.InvalidArgument, "invalid state")
	}
...
func (s *LedgerService) Prove(ctx context.Context, req *ledgerpb.ProveRequest) (*ledgerpb.ProofResponse, error) {
	if req.State == nil || len(req.State.Hash) != len(ledger.State{}) {
		return nil, status.Error(codes.InvalidArgument, "invalid state")
	}
