...
func main() {
	...
	cmd.FlowNode(flow.RoleExecution.String()).
		ExtraFlags(func(flags *pflag.FlagSet) {
			...
			flags.Uint32Var(&mTrieCacheSize, "mtrie-cache-size", 400, "cache size for MTrie")
			...
			flags.UintVar(&stateDeltasLimit, "state-deltas-limit", 10, "maximum number of state deltas in the memory pool")
