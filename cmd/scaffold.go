...
func (fnb *FlowNodeBuilder) BaseFlags() {
	...
	fnb.flags.Uint32Var(&fnb.BaseConfig.GossipSubRPCInspectorsConfig.ValidationInspectorConfigs.InspectMessageQueueCacheSize, "gossipsub-rpc-validation-inspector-queue-cache-size", defaultConfig.GossipSubRPCInspectorsConfig.ValidationInspectorConfigs.InspectMessageQueueCacheSize, "cache size for gossipsub RPC validation inspector events worker pool queue.")
	fnb.flags.Uint32Var(&fnb.BaseConfig.GossipSubRPCInspectorsConfig.ValidationInspectorConfigs.ClusterPrefixedTopicsReceivedCacheSize, "gossipsub-cluster-prefix-tracker-cache-size", defaultConfig.GossipSubRPCInspectorsConfig.ValidationInspectorConfigs.ClusterPrefixedTopicsReceivedCacheSize, "cache size for gossipsub RPC validation inspector cluster prefix received tracker.")
