...
func (fnb *FlowNodeBuilder) EnqueueNetworkInit() {
	...
	fnb.Component(LibP2PNodeComponent, func(node *NodeConfig) (module.ReadyDoneAware, error) {
		...
		rpcValidationInspector, err := p2pbuilder.BuildGossipSubRPCValidationInspector(fnb.Logger, fnb.SporkID, fnb.GossipSubRPCValidationConfigs, fnb.GossipSubInspectorNotifDistributor, fnb.Metrics.Network, heroStoreOpts...)
		if err != nil {
