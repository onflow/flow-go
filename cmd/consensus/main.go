...
func main() {
	...
	nodeBuilder.ExtraFlags(func(flags *pflag.FlagSet) {
		...
		flags.DurationVar(&cruiseCtlConfig.MinViewDuration, "cruise-ctl-min-view-duration", cruiseCtlConfig.MinViewDuration, "the lower bound of authority for the controller, when active. This is the smallest amount of time a view is allowed to take.")
		flags.DurationVar(&cruiseCtlConfig.MaxViewDuration, "cruise-ctl-max-view-duration", cruiseCtlConfig.MaxViewDuration, "the upper bound of authority for the controller when active. This is the largest amount of time a view is allowed to take.")
		flags.BoolVar(&cruiseCtlConfig.Enabled, "cruise-ctl-enabled", cruiseCtlConfig.Enabled, "whether the block time controller is enabled; when disabled, the FallbackProposalDuration is used")
