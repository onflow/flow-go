...
func (builder *FlowAccessNodeBuilder) buildFollowerEngine() *FlowAccessNodeBuilder {
	builder.Component("follower engine", func(node *cmd.NodeConfig) (module.ReadyDoneAware, error) {
		...
		builder.FinalizationDistributor.AddOnBlockFinalizedConsumer(builder.FollowerEng.OnFinalizedBlock)
...
func (builder *FlowAccessNodeBuilder) extraFlags() {
	builder.ExtraFlags(func(flags *pflag.FlagSet) {
		...
		flags.StringVarP(&builder.ArchiveNodeAddress, "achive-address", "", defaultConfig.ArchiveNodeAddress, "the address of the archive node forward the script queries to")
