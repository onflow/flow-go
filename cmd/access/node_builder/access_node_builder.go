...
func (builder *FlowAccessNodeBuilder) extraFlags() {
	builder.ExtraFlags(func(flags *pflag.FlagSet) {
		...
		flags.BoolVar(&builder.rpcConf.ScriptExecValidation, "validate-rn-script-exec", defaultConfig.rpcConf.ScriptExecValidation, "whether to validate script execution results from the archive node with results from the execution node")
