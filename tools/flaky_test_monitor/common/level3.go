...
type TestSummary3 struct {
	NoResults []TestRunsLevel2Summary `json:"no_results"`
	...
	MostFailures []TestRunsLevel2Summary `json:"most_failures"`
	...
	LongestRunning []TestRunsLevel2Summary `json:"longest_running"`
