...
type testRuntimeInterface struct {
	...
	addAccountKey      func(address types.Address, publicKey []byte) error
...
func (i *testRuntimeInterface) CreateAccount(publicKeys [][]byte, code []byte) (address types.Address, err error) {
	return i.createAccount(publicKeys, code)
}

func (i *testRuntimeInterface) AddAccountKey(address types.Address, publicKey []byte) error {
