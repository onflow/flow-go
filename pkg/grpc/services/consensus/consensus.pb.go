...
type ProcessStateTransitionProposalRequest struct {
	Transition           *SignedStateTransition `protobuf:"bytes,1,opt,name=transition,proto3" json:"transition,omitempty"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
func (m *ProcessStateTransitionProposalRequest) GetTransition() *SignedStateTransition {
	if m != nil {
		return m.Transition
	}
	return nil
...
var fileDescriptor_e74762047b656a23 = []byte{
	...
	,
}
