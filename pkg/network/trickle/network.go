...
func NewNetwork(log zerolog.Logger, codec codec.Codec, com module.Committee, mw Middleware, state State, cache Cache) (*Network, error) {
...
// processGossip will process the payload of an event sent to us by a peer.
func (n *Network) processGossip(peerID string, res *trickle.Response) error {
