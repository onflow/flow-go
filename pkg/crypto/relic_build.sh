...
#
BN_METH="-DBN_KARAT=1 -DBN_METHD=\"COMBA;COMBA;MONTY;SLIDE;STEIN;STRON\""
FP_METH="-DFP_KARAT=1 -DFP_METHD=\"INTEG;INTEG;INTEG;MONTY;LOWER;SLIDE\""
PRIMES="-DFP_PMERS=OFF -DFP_QNRES=ON -DFP_WIDTH=3"
FPX_METH="-DFPX_METHD=\"INTEG;INTEG;LAZYR\""
CURVES="-DEP_MIXED=ON -DEP_PLAIN=OFF -DEP_SUPER=OFF -DEP_DEPTH=3 -DEP_WIDTH=3"
...
cmake -DCOMP="-O3 -funroll-loops -fomit-frame-pointer -march=native -mtune=native" \
    ...
    $CURVES \
    -DBN_KARAT=1 -DBN_METHD="COMBA;COMBA;MONTY;SLIDE;STEIN;STRON" \
    -DFP_KARAT=1 -DFP_METHD="INTEG;INTEG;INTEG;MONTY;LOWER;SLIDE" \
