...
func TestBinstatInternal(t *testing.T) {
	...
	require.Equal(t, "1", x_2_y(1.234567, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.123456, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.012345, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.001234, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.000123, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.000012, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.000001, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.000000, isIntIsTrue))

	require.Equal(t, "200-299", x_2_y(234.567890, isIntIsTrue))
	require.Equal(t, "20-29", x_2_y(23.456789, isIntIsTrue))
	require.Equal(t, "2", x_2_y(2.345678, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.234567, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.023456, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.002345, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.000234, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.000023, isIntIsTrue))
	require.Equal(t, "0", x_2_y(0.000002, isIntIsTrue))
