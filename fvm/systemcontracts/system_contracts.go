...
var (
	...
	// TBD
	versionContractAddressMainnet = flow.Mainnet.Chain().ServiceAddress()
	versionContractAddressTestnet = flow.Testnet.Chain().ServiceAddress()
)
