...
func (tc *TestContract) MakeCallData(t *testing.T, name string, args ...interface{}) []byte {
...
func GetDummyKittyTestContract(t *testing.T) *TestContract {
...
func RunWithDeployedContract(t *testing.T, tc *TestContract, led atree.Ledger, flowEVMRootAddress flow.Address, f func(*TestContract)) {
	// deploy contract
