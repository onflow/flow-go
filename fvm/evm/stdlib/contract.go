...
type InternalEVMFunctions struct {
	...
	CallWithSigAndArgs        *vm.NativeFunctionValue
	RunTxAs                   *vm.NativeFunctionValue
	...
	DryCallWithSigAndArgs     *vm.NativeFunctionValue
	CommitBlockProposal       *vm.NativeFunctionValue
	Store                     *vm.NativeFunctionValue
	Load                      *vm.NativeFunctionValue
}
...
func SetupEnvironment(
	...
	env.DeclareValue(
		stdlib.StandardLibraryValue{
			...
			Type:  InternalEVMTypeCallWithSigAndArgsFunctionType,
			Value: internalEVMFunctions.CallWithSigAndArgs,
			Kind:  common.DeclarationKindFunction,
		},
		location,
	)
	env.DeclareValue(
		stdlib.StandardLibraryValue{
			...
			Type:  InternalEVMTypeRunTxAsFunctionType,
			Value: internalEVMFunctions.RunTxAs,
			Kind:  common.DeclarationKindFunction,
		},
		location,
	)
	...
	env.DeclareValue(
		stdlib.StandardLibraryValue{
			...
			Value: internalEVMFunctions.DryCallWithSigAndArgs,
			Kind:  common.DeclarationKindFunction,
		},
		location,
	)
	...
	env.DeclareValue(
		stdlib.StandardLibraryValue{
			...
			Type:  InternalEVMTypeStoreFunctionType,
			Value: internalEVMFunctions.Store,
			Kind:  common.DeclarationKindFunction,
		},
		location,
	)
	env.DeclareValue(
		stdlib.StandardLibraryValue{
			...
			Value: internalEVMFunctions.Load,
			Kind:  common.DeclarationKindFunction,
		},
		location,
	)
