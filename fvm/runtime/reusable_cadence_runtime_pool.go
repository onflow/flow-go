...
func (pool ReusableCadenceRuntimePool) Borrow(
	...
	case environment.CadenceScriptVMRuntime:
		return reusableCadenceScriptVMRuntime{
			reusableCadenceRuntime: reusable,
		}
	case environment.CadenceTransactionVMRuntime:
		return reusableCadenceTransactionVMRuntime{
			reusableCadenceRuntime: reusable,
		}
	default:
		panic("unreachable")
...
func (pool ReusableCadenceRuntimePool) Return(
	...
	case reusableCadenceTransactionRuntime:
		inner = v.reusableCadenceRuntime
	case reusableCadenceScriptVMRuntime:
		inner = v.reusableCadenceRuntime
	case reusableCadenceTransactionVMRuntime:
		inner = v.reusableCadenceRuntime
	default:
		panic("unreachable")
	}
