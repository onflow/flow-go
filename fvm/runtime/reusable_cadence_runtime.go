...
func (reusable *ReusableCadenceRuntime) declareStandardLibraryFunctions() {
	...
	reusable.TxRuntimeEnv.DeclareValue(transactionIndexDeclaration(reusable), nil)
	reusable.ScriptRuntimeEnv.DeclareValue(transactionIndexDeclaration(reusable), nil)
}
