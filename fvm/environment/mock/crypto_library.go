...
func (_m *CryptoLibrary) BLSAggregatePublicKeys(keys []*runtime.PublicKey) (*runtime.PublicKey, error) {
	ret := _m.Called(keys)
...
func (_m *CryptoLibrary) BLSVerifyPOP(pk *runtime.PublicKey, sig []byte) (bool, error) {
...
func (_m *CryptoLibrary) Hash(data []byte, tag string, hashAlgorithm runtime.HashAlgorithm) ([]byte, error) {
...
func (_m *CryptoLibrary) ValidatePublicKey(pk *runtime.PublicKey) error {
	ret := _m.Called(pk)
...
func (_m *CryptoLibrary) VerifySignature(signature []byte, tag string, signedData []byte, publicKey []byte, signatureAlgorithm runtime.SignatureAlgorithm, hashAlgorithm runtime.HashAlgorithm) (bool, error) {
