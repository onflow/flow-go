...
func (_m *Environment) AddEncodedAccountKey(address common.Address, publicKey []byte) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for AddEncodedAccountKey")
	}
...
func (_m *Environment) GetProgramDependencies() (derived.ProgramDependencies, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetProgramDependencies")
	}
...
func (_m *Environment) RevokeEncodedAccountKey(address common.Address, index int) ([]byte, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for RevokeEncodedAccountKey")
	}
