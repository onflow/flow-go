...
// NewProcedure creates a new instance of Procedure. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewProcedure(t testing.TB) *Procedure {
	mock := &Procedure{}
	mock.Mock.Test(t)
