...
func (_m *ScriptProcessor) Process(_a0 fvm.Context, _a1 *fvm.ScriptProcedure, _a2 *state.StateHolder, _a3 *programs.TransactionPrograms) error {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 error
	if rf, ok := ret.Get(0).(func(fvm.Context, *fvm.ScriptProcedure, *state.StateHolder, *programs.TransactionPrograms) error); ok {
