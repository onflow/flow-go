...
func (_m *ASTCache) GetProgram(_a0 common.Location) (*ast.Program, error) {
	ret := _m.Called(_a0)

	var r0 *ast.Program
	if rf, ok := ret.Get(0).(func(common.Location) *ast.Program); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_m *ASTCache) SetProgram(_a0 common.Location, _a1 *ast.Program) error {
	ret := _m.Called(_a0, _a1)

	var r0 error
	if rf, ok := ret.Get(0).(func(common.Location, *ast.Program) error); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Error(0)
	}
