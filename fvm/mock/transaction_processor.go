...
func (_m *TransactionProcessor) Process(_a0 *fvm.VirtualMachine, _a1 *fvm.Context, _a2 *fvm.TransactionProcedure, _a3 *state.StateHolder, _a4 *programs.TransactionPrograms) error {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4)

	var r0 error
	if rf, ok := ret.Get(0).(func(*fvm.VirtualMachine, *fvm.Context, *fvm.TransactionProcedure, *state.StateHolder, *programs.TransactionPrograms) error); ok {
