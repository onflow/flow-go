...
// NewTransactionProcessor creates a new instance of TransactionProcessor. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTransactionProcessor(t testing.TB) *TransactionProcessor {
