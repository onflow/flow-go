...
// NewAccounts creates a new instance of Accounts. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAccounts(t testing.TB) *Accounts {
	mock := &Accounts{}
	mock.Mock.Test(t)
