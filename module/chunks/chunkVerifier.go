...
func (fcv *ChunkVerifier) Verify(vc *verification.VerifiableChunkData) ([]byte, chmodels.ChunkFault, error) {
	...
	return fcv.verifyTransactions(vc.TransactionOffset, vc.Chunk, vc.ChunkDataPack, vc.Result, vc.Header, transactions, vc.EndState)
}
...
func (fcv *ChunkVerifier) SystemChunkVerify(vc *verification.VerifiableChunkData) ([]byte, chmodels.ChunkFault, error) {
	...
	return fcv.verifyTransactionsInContext(systemChunkContext, vc.TransactionOffset, vc.Chunk, vc.ChunkDataPack, vc.Result, transactions, vc.EndState, true)
}
...
func (fcv *ChunkVerifier) verifyTransactionsInContext(
	...
	programs := programs.NewEmptyBlockProgramsWithTransactionOffset(transactionOffset)
...
func (fcv *ChunkVerifier) verifyTransactions(
	...
	return fcv.verifyTransactionsInContext(blockCtx, transactionOffset, chunk, chunkDataPack, result, transactions, endState, false)
}
