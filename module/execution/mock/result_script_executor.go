...
// ResultScriptExecutor is an autogenerated mock type for the ResultScriptExecutor type
...
func (_m *ResultScriptExecutor) ExecuteAtBlockHeight(ctx context.Context, script []byte, arguments [][]byte, height uint64, executionResultID flow.Identifier) ([]byte, error) {
...
func (_m *ResultScriptExecutor) GetAccountAtBlockHeight(ctx context.Context, address flow.Address, height uint64) (*flow.Account, error) {
...
func (_m *ResultScriptExecutor) GetAccountAvailableBalance(ctx context.Context, address flow.Address, height uint64) (uint64, error) {
	ret := _m.Called(ctx, address, height)
...
func (_m *ResultScriptExecutor) GetAccountBalance(ctx context.Context, address flow.Address, height uint64) (uint64, error) {
	ret := _m.Called(ctx, address, height)
...
func (_m *ResultScriptExecutor) GetAccountKey(ctx context.Context, address flow.Address, keyIndex uint32, height uint64) (*flow.AccountPublicKey, error) {
...
func (_m *ResultScriptExecutor) GetAccountKeys(ctx context.Context, address flow.Address, height uint64) ([]flow.AccountPublicKey, error) {
	ret := _m.Called(ctx, address, height)
...
// NewResultScriptExecutor creates a new instance of ResultScriptExecutor. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewResultScriptExecutor(t interface {
	mock.TestingT
	Cleanup(func())
}) *ResultScriptExecutor {
	mock := &ResultScriptExecutor{}
	mock.Mock.Test(t)
