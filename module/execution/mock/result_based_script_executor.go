...
// ResultBasedScriptExecutor is an autogenerated mock type for the ResultBasedScriptExecutor type
type ResultBasedScriptExecutor struct {
	mock.Mock
}

// ExecuteAtBlockHeight provides a mock function with given fields: ctx, script, arguments, height, executionResultID
func (_m *ResultBasedScriptExecutor) ExecuteAtBlockHeight(ctx context.Context, script []byte, arguments [][]byte, height uint64, executionResultID flow.Identifier) ([]byte, error) {
	ret := _m.Called(ctx, script, arguments, height, executionResultID)
	...
	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []byte, [][]byte, uint64, flow.Identifier) ([]byte, error)); ok {
		return rf(ctx, script, arguments, height, executionResultID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []byte, [][]byte, uint64, flow.Identifier) []byte); ok {
		r0 = rf(ctx, script, arguments, height, executionResultID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, []byte, [][]byte, uint64, flow.Identifier) error); ok {
		r1 = rf(ctx, script, arguments, height, executionResultID)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ResultBasedScriptExecutor) GetAccountAtBlockHeight(ctx context.Context, address flow.Address, height uint64) (*flow.Account, error) {
...
func (_m *ResultBasedScriptExecutor) GetAccountAvailableBalance(ctx context.Context, address flow.Address, height uint64) (uint64, error) {
	ret := _m.Called(ctx, address, height)
...
func (_m *ResultBasedScriptExecutor) GetAccountBalance(ctx context.Context, address flow.Address, height uint64) (uint64, error) {
	ret := _m.Called(ctx, address, height)
...
func (_m *ResultBasedScriptExecutor) GetAccountKey(ctx context.Context, address flow.Address, keyIndex uint32, height uint64) (*flow.AccountPublicKey, error) {
...
func (_m *ResultBasedScriptExecutor) GetAccountKeys(ctx context.Context, address flow.Address, height uint64) ([]flow.AccountPublicKey, error) {
	ret := _m.Called(ctx, address, height)
...
// NewResultBasedScriptExecutor creates a new instance of ResultBasedScriptExecutor. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewResultBasedScriptExecutor(t interface {
	mock.TestingT
	Cleanup(func())
}) *ResultBasedScriptExecutor {
	mock := &ResultBasedScriptExecutor{}
	mock.Mock.Test(t)
