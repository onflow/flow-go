...
func (bs *BuilderSuite) SetupTest() {
	...
	db := bs.db
	err := unittest.WithLocks(bs.T(), lockManager, []string{storage.LockBootstrapping, storage.LockInsertBlock, storage.LockFinalizeBlock}, func(lctx lockctx.Context) error {
