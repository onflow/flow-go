...
type GenericPendingBlockBuffer[T module.BufferedProposal] struct {
	mock.Mock
}
...
func (_m *GenericPendingBlockBuffer[T]) ByID(blockID flow.Identifier) (flow.Slashable[T], bool) {
	...
	var r0 flow.Slashable[T]
	var r1 bool
	if rf, ok := ret.Get(0).(func(flow.Identifier) (flow.Slashable[T], bool)); ok {
		return rf(blockID)
	}
	if rf, ok := ret.Get(0).(func(flow.Identifier) flow.Slashable[T]); ok {
		r0 = rf(blockID)
	} else {
		r0 = ret.Get(0).(flow.Slashable[T])
	}
...
func (_m *GenericPendingBlockBuffer[T]) ByParentID(parentID flow.Identifier) ([]flow.Slashable[T], bool) {
...
func NewGenericPendingBlockBuffer[T module.BufferedProposal](t interface {
	mock.TestingT
	Cleanup(func())
