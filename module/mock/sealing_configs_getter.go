...
// NewSealingConfigsGetter creates a new instance of SealingConfigsGetter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSealingConfigsGetter(t testing.TB) *SealingConfigsGetter {
