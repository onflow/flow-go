...
type mockConstructorTestingTNewExecutionDataServiceMetrics interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewExecutionDataServiceMetrics(t mockConstructorTestingTNewExecutionDataServiceMetrics) *ExecutionDataServiceMetrics {
