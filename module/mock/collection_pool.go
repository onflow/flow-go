...
func (_m *CollectionPool) Add(coll *collection.GuaranteedCollection) error {
	ret := _m.Called(coll)
...
func (_m *CollectionPool) All() []*collection.GuaranteedCollection {
	ret := _m.Called()
...
func (_m *CollectionPool) Get(hash crypto.Hash) (*collection.GuaranteedCollection, error) {
	ret := _m.Called(hash)
