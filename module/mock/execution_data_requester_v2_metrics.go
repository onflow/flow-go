...
type NewExecutionDataRequesterV2MetricsT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewExecutionDataRequesterV2Metrics(t NewExecutionDataRequesterV2MetricsT) *ExecutionDataRequesterV2Metrics {
