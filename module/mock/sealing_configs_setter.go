...
func (_m *SealingConfigsSetter) SetRequiredApprovalsForSealingConstruction(newVal uint) (uint, error) {
...
// NewSealingConfigsSetter creates a new instance of SealingConfigsSetter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSealingConfigsSetter(t testing.TB) *SealingConfigsSetter {
