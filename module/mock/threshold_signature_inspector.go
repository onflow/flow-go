...
func (_m *ThresholdSignatureInspector) EnoughShares() bool {
	ret := _m.Called()
...
func (_m *ThresholdSignatureInspector) HasShare(index int) (bool, error) {
	ret := _m.Called(index)
...
func (_m *ThresholdSignatureInspector) ThresholdSignature() (crypto.Signature, error) {
	ret := _m.Called()
...
func (_m *ThresholdSignatureInspector) TrustedAdd(index int, share crypto.Signature) (bool, error) {
...
func (_m *ThresholdSignatureInspector) VerifyAndAdd(index int, share crypto.Signature) (bool, bool, error) {
	ret := _m.Called(index, share)
...
func (_m *ThresholdSignatureInspector) VerifyShare(index int, share crypto.Signature) (bool, error) {
	ret := _m.Called(index, share)
...
func (_m *ThresholdSignatureInspector) VerifyThresholdSignature(thresholdSignature crypto.Signature) (bool, error) {
