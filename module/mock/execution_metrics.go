...
// ExecutionBlockAddedToWorkQueue provides a mock function with given fields:
func (_m *ExecutionMetrics) ExecutionBlockAddedToWorkQueue() {
	_m.Called()
}
...
// ExecutionBlockRemovedFromWorkQueue provides a mock function with given fields:
func (_m *ExecutionMetrics) ExecutionBlockRemovedFromWorkQueue() {
	_m.Called()
}
