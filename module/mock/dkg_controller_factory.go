...
func (_m *DKGControllerFactory) Create(dkgInstanceID string, participants flow.IdentitySkeletonList, seed []byte) (module.DKGController, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, flow.IdentitySkeletonList, []byte) (module.DKGController, error)); ok {
		return rf(dkgInstanceID, participants, seed)
	}
	if rf, ok := ret.Get(0).(func(string, flow.IdentitySkeletonList, []byte) module.DKGController); ok {
	...
	if rf, ok := ret.Get(1).(func(string, flow.IdentitySkeletonList, []byte) error); ok {
