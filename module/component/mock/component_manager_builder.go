...
// NewComponentManagerBuilder creates a new instance of ComponentManagerBuilder. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewComponentManagerBuilder(t testing.TB) *ComponentManagerBuilder {
