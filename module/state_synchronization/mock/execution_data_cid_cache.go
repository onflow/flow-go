...
type mockConstructorTestingTNewExecutionDataCIDCache interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewExecutionDataCIDCache(t mockConstructorTestingTNewExecutionDataCIDCache) *ExecutionDataCIDCache {
	mock := &ExecutionDataCIDCache{}
	mock.Mock.Test(t)
