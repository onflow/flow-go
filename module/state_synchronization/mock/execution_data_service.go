...
type mockConstructorTestingTNewExecutionDataService interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewExecutionDataService(t mockConstructorTestingTNewExecutionDataService) *ExecutionDataService {
