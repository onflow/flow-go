...
func NewExecutionCollector(tracer *trace.OpenTracer, registerer *Registerer) *ExecutionCollector {
	ec := &ExecutionCollector{
		tracer: tracer,

		forestApproxMemorySize: registerer.RegisterNewGauge(prometheus.GaugeOpts{
		...
		forestNumberOfTrees: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		latestTrieRegCount: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		latestTrieRegCountDiff: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		latestTrieMaxDepth: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		latestTrieMaxDepthDiff: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		updated: registerer.RegisterNewCounter(prometheus.CounterOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		proofSize: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		updatedValuesNumber: registerer.RegisterNewCounter(prometheus.CounterOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		updatedValuesSize: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		updatedDuration: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		updatedDurationPerValue: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		readValuesNumber: registerer.RegisterNewCounter(prometheus.CounterOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		readValuesSize: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		readDuration: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
			Name:      "read_duration",
		...
		readDurationPerValue: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemMTrie,
		...
		collectionRequestSent: registerer.RegisterNewCounter(prometheus.CounterOpts{
			Namespace: namespaceExecution,
		...
		collectionRequestRetried: registerer.RegisterNewCounter(prometheus.CounterOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemIngestion,
		...
		transactionParseTime: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
		...
		transactionCheckTime: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemRuntime,
		...
		transactionInterpretTime: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemRuntime,
		...
		totalChunkDataPackRequests: registerer.RegisterNewCounter(prometheus.CounterOpts{
			Namespace: namespaceExecution,
		...
		gasUsedPerBlock: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemRuntime,
		...
		stateReadsPerBlock: registerer.RegisterNewHistogram(prometheus.HistogramOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemRuntime,
		...
		totalExecutedTransactionsCounter: registerer.RegisterNewCounter(prometheus.CounterOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemRuntime,
		...
		lastExecutedBlockViewGauge: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemRuntime,
		...
		stateStorageDiskTotal: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
		...
		storageStateCommitment: registerer.RegisterNewGauge(prometheus.GaugeOpts{
			Namespace: namespaceExecution,
			Subsystem: subsystemStateStorage,
