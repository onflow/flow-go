...
func NewHotstuffCollector(chain flow.ChainID, registerer prometheus.Registerer) *HotstuffCollector {

	hc := &HotstuffCollector{

		busyDuration: prometheus.NewHistogramVec(prometheus.HistogramOpts{
		...
		busyDurationCsCounter: prometheus.NewCounterVec(prometheus.CounterOpts{
		...
		idleDurationCsCounter: prometheus.NewCounter(prometheus.CounterOpts{
		...
		waitDurationCsCounter: prometheus.NewCounterVec(prometheus.CounterOpts{
		...
		qcView: prometheus.NewGauge(prometheus.GaugeOpts{
			Name:        "qc_view",
			Namespace:   namespaceConsensus,
			Subsystem:   subsystemHotstuff,
		...
		timeoutDuration: prometheus.NewGauge(prometheus.GaugeOpts{
		...
		committeeComputationsCsCounter: prometheus.NewCounter(prometheus.CounterOpts{
		...
		signerComputationsCsCounter: prometheus.NewCounter(prometheus.CounterOpts{
		...
		validatorComputationsCsCounter: prometheus.NewCounter(prometheus.CounterOpts{
		...
		payloadProductionCsCounter: prometheus.NewCounter(prometheus.CounterOpts{
	...
	registerAllFields(hc, registerer)
