...
func NewRestCollector(cfg metricsProm.Config) module.RestMetrics {
	...
	r := &RestCollector{
		...
		}, []string{cfg.ServiceLabel, cfg.MethodLabel}),
	}
...
func (r *RestCollector) AddTotalRequests(_ context.Context, serviceID string, method string) {
	r.httpRequestsTotal.WithLabelValues(serviceID, method).Inc()
}
