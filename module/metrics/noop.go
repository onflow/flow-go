...
func (nc *NoopCollector) MessageReceived(engine string, message string, originID flow.Identifier) {}
func (nc *NoopCollector) MessageHandled(engine string, message string, originID flow.Identifier)  {}
