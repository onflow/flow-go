...
const (
	...
	ResourceReceiveCache                     = "networking_received_message" // networking layer
	ResourceDnsIpCache                       = "dns_ip_cache"                // networking layer
	ResourceDnsTxtCache                      = "dns_txt_cache"               // networking layer
	ResourceDisallowListNotificationQueue    = "disallow_list_notification_queue"
	ResourceRpcInspectorNotificationQueue    = "rpc_inspector_notification_queue"
	ResourceRpcValidationInspectorQueue      = "rpc_validation_inspector_queue"
	ResourceRpcMetricsObserverInspectorQueue = "rpc_metrics_observer_inspector_queue"
