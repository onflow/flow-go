...
type ExecutionMetrics interface {
	...
	ExecutionBlockExecutionEffortVectorComponent(string, uint64)
	...
	ExecutionScheduledTransactionsExecuted(transactionCount int, processComputationUsed, executeComputationLimits uint64)
