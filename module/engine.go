...
// This is the interface all engines should implement in order to have a
...
type Engine interface {
	...
	Submit(channel network.Channel, originID flow.Identifier, event interface{})
	...
	// done.
	Process(channel network.Channel, originID flow.Identifier, event interface{}) error
}
