...
func getUint64Value(item edstorage.StorageItem) (uint64, error) {
...
func getBatchItemCountLimit(db edstorage.StorageDB, writeCountPerItem int64, writeSizePerItem int64) int {
...
func OpenStorage(db edstorage.StorageDB, startHeight uint64, logger zerolog.Logger, opts ...StorageOption) (*storage, error) {
