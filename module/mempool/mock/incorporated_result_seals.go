...
// NewIncorporatedResultSeals creates a new instance of IncorporatedResultSeals. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewIncorporatedResultSeals(t testing.TB) *IncorporatedResultSeals {
