...
// NewIdentifierMap creates a new instance of IdentifierMap. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewIdentifierMap(t testing.TB) *IdentifierMap {
	mock := &IdentifierMap{}
	mock.Mock.Test(t)
