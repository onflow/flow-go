...
// NewAssignments creates a new instance of Assignments. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAssignments(t testing.TB) *Assignments {
	mock := &Assignments{}
	mock.Mock.Test(t)
