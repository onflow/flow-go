...
func (_m *Assignments) Add(assignmentFingerprint flow.Identifier, assignment *chmodels.Assignment) error {
	ret := _m.Called(assignmentFingerprint, assignment)

	var r0 error
	if rf, ok := ret.Get(0).(func(flow.Identifier, *chmodels.Assignment) error); ok {
...
func (_m *Assignments) All() []*chmodels.Assignment {
	ret := _m.Called()

	var r0 []*chmodels.Assignment
	if rf, ok := ret.Get(0).(func() []*chmodels.Assignment); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*chmodels.Assignment)
		}
	}
...
func (_m *Assignments) ByID(assignmentID flow.Identifier) (*chmodels.Assignment, error) {
	ret := _m.Called(assignmentID)

	var r0 *chmodels.Assignment
	if rf, ok := ret.Get(0).(func(flow.Identifier) *chmodels.Assignment); ok {
		r0 = rf(assignmentID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*chmodels.Assignment)
