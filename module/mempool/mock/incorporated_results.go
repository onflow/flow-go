...
// ByIncorporatedBlockID provides a mock function with given fields: blockID
func (_m *IncorporatedResults) ByIncorporatedBlockID(blockID flow.Identifier) []*flow.IncorporatedResult {
