...
// NewExecutionTree creates a new instance of ExecutionTree. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExecutionTree(t testing.TB) *ExecutionTree {
	mock := &ExecutionTree{}
	mock.Mock.Test(t)
