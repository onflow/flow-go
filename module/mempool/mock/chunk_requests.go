...
// NewChunkRequests creates a new instance of ChunkRequests. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewChunkRequests(t testing.TB) *ChunkRequests {
	mock := &ChunkRequests{}
	mock.Mock.Test(t)
