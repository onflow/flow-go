...
// NewChunkStatuses creates a new instance of ChunkStatuses. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewChunkStatuses(t testing.TB) *ChunkStatuses {
	mock := &ChunkStatuses{}
	mock.Mock.Test(t)
