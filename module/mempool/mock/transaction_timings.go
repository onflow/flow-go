...
// NewTransactionTimings creates a new instance of TransactionTimings. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTransactionTimings(t testing.TB) *TransactionTimings {
