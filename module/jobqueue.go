...
const (
	...
	ConsumeProgressProtocolDBPrunerByHeight = "ConsumeProgressProtocolDBPrunerByHeight"
	ConsumeProgressProtocolDBPrunerByView   = "ConsumeProgressProtocolDBPrunerByView"
)
