...
func TestCreateAccount(t *testing.T) {
	...
	scriptA := accounts.CreateAccount(publicKey, []byte{})

	Expect(scriptA).To(Equal([]byte(`
		fun main(account: Account) {
			let publicKey: Int[]? = [4,136,178,30,0,0,0,0,0,0,0,0,0,111,117,56,107,245,122,184,40,127,172,19,175,225,131,184,22,122,23,90,172,214,144,150,92,69,119,218,11,191,120,226,74,2,217,156,75,44,44,121,152,143,47,180,169,205,18,77,47,135,146,34,34,157,69,149,177,141,80,99,66,186,33,25,73,179,224,166,205,172]
			let code: Int[]? = nil
	...
	scriptB := accounts.CreateAccount(publicKey, []byte("fun main() {}"))
