...
func TestMinting(t *testing.T) {
	...
	createMinterTx := flow.Transaction{TransactionBody: flow.TransactionBody{
		Script:         GenerateCreateMinterScript(contractAddr, 1, 2),
		Nonce:          GetNonce(),
		ComputeLimit:   10,
		PayerAccount:   b.RootAccountAddress(),
	...
	// Mint the first NFT
	mintTx := flow.Transaction{TransactionBody: flow.TransactionBody{
	...
	// Mint a second NF
	mintTx2 := flow.Transaction{TransactionBody: flow.TransactionBody{
		Script:         GenerateMintScript(contractAddr),
		Nonce:          GetNonce(),
		ComputeLimit:   10,
		PayerAccount:   b.RootAccountAddress(),
