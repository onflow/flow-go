...
func TestCreateAccount(t *testing.T) {
	...
	expectedScriptB := []byte(`
        transaction {
          execute {
            priv let publicKeys: [[Int]] = [[248,98,184,91,48,89,48,19,6,7,42,134,72,206,61,2,1,6,8,42,134,72,206,61,3,1,7,3,66,0,4,114,176,116,164,82,208,167,100,161,218,52,49,143,68,203,22,116,13,241,207,171,30,107,80,229,228,20,93,192,110,93,21,28,156,37,36,79,18,62,83,201,182,254,35,117,4,163,126,119,121,144,10,173,83,202,38,227,181,124,92,61,112,48,196,2,3,130,3,232]]
            priv let code: [Int]? = [112,117,98,32,102,117,110,32,109,97,105,110,40,41,32,123,125]
            createAccount(publicKeys, code)
          }
        }
    `)
