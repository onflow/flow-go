...
docker-build-collection:
	docker build --no-cache -f cmd/Dockerfile  --build-arg TARGET=collection --build-arg COMMIT=$(COMMIT)  --build-arg VERSION=$(IMAGE_TAG) --target production \
...
docker-build-consensus:
	docker build --no-cache -f cmd/Dockerfile  --build-arg TARGET=consensus --build-arg COMMIT=$(COMMIT)  --build-arg VERSION=$(IMAGE_TAG) --target production \
...
docker-build-execution:
	docker build --no-cache -f cmd/Dockerfile  --build-arg TARGET=execution --build-arg COMMIT=$(COMMIT)  --build-arg VERSION=$(IMAGE_TAG) --target production \
...
docker-build-verification:
	docker build --no-cache -f cmd/Dockerfile  --build-arg TARGET=verification --build-arg COMMIT=$(COMMIT)  --build-arg VERSION=$(IMAGE_TAG) --target production \
...
docker-build-bootstrap:
	docker build --no-cache -f cmd/Dockerfile  --build-arg TARGET=bootstrap --target production \
