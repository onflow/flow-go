...
generate-mocks:
	...
	GO111MODULE=on mockery -name '.*' -dir=network/protocol -case=underscore -output="./network/mock" -outpkg="mock"
	GO111MODULE=on mockery -name '.*' -dir=network/protocol -case=underscore -output="./network/mock" -outpkg="mock"
	GO111MODULE=on mockery -name 'Connector' -dir=network/protocol/ -case=underscore -output="./network/mock" -outpkg="mock"
	GO111MODULE=on mockery -name 'SubscriptionManager' -dir=network/ -case=underscore -output="./network/mock" -outpkg="mock"
