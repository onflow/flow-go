...
generate-mocks: install-mock-generators
	...
	mockery --name 'IndexerScriptExecutor' --dir=module/execution --case=underscore --output="module/execution/mock" --outpkg="mock"
	mockery --name 'ResultScriptExecutor' --dir=module/execution --case=underscore --output="module/execution/mock" --outpkg="mock"
