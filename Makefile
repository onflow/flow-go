...
generate-mocks:
	...
	GO111MODULE=on mockery -name 'ExecutionDataService' -dir=module/state_synchronization -case=underscore -output="./module/state_synchronization/mock" -outpkg="state_synchronization"
