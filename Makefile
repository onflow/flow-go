...
generate-mocks:
	GO111MODULE=on mockgen -destination=storage/mocks/storage.go -package=mocks github.com/dapperlabs/flow-go/storage Blocks,Payloads,Collections,Commits,Events
	...
	GO111MODULE=on mockgen -destination=state/protocol/mocks/state.go -package=mocks github.com/dapperlabs/flow-go/state/protocol State
	...
	GO111MODULE=on mockgen -destination=state/protocol/mocks/snapshot.go -package=mocks github.com/dapperlabs/flow-go/state/protocol Snapshot
	GO111MODULE=on mockgen -destination=state/protocol/mocks/mutator.go -package=mocks github.com/dapperlabs/flow-go/state/protocol Mutator
