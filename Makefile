...
GO111MODULE=on mockery -name 'Distributor' -dir="./engine/consensus/hotstuff/notifications/" -case=underscore -output="./engine/consensus/hotstuff/notifications/mock" -outpkg="mock"
GO111MODULE=on mockery -name 'Vertex' -dir="./engine/consensus/hotstuff/forks/finalizer/forrest" -case=underscore -output="./engine/consensus/hotstuff/forks/finalizer/forrest/mock" -outpkg="mock"
