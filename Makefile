...
generate-mocks: install-mock-generators
	...
	mockery --name 'TransactionRetriever' --dir="./engine/access/rpc/backend/transactions/retriever" --case=underscore --output="./engine/access/rpc/backend/transactions/retriever/mock" --outpkg="mock"
	mockery --name 'TxErrorMessageRetriever' --dir="./engine/access/rpc/backend/transactions/error_message_retriever" --case=underscore --output="./engine/access/rpc/backend/transactions/error_message_retriever/mock" --outpkg="mock"
