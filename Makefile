...
docker-build-util:
	docker build -f cmd/Dockerfile --build-arg TARGET=util --target production \
...
docker-build-remove-execution-fork:
	docker build -f cmd/Dockerfile --build-arg TARGET=util/cmd/remove-execution-fork --target production \
