...
// Returns the key for storting the given event. It is a concatenation of:
// storage prefix, block ID, transaction ID, transaction index, and event index.
...
// Requires [storage.LockInsertEvent] to be held for thread safety.
...
// Requires [storage.LockInsertServiceEvent] to be held for thread safety.
// It returns [storage.ErrAlreadyExists] if events for the block already exist.
