...
func IndexSealPayload(height uint64, blockID flow.Identifier, parentID flow.Identifier, sealIDs flow.IdentifierList) func(*badger.Txn) error {
	return insert(toPayloadIndex(codeIndexSeal, height, blockID, parentID), sealIDs)
}

func LookupSealPayload(height uint64, blockID flow.Identifier, parentID flow.Identifier, sealIDs *flow.IdentifierList) func(*badger.Txn) error {
...
func VerifySealPayload(height uint64, blockID flow.Identifier, sealIDs flow.IdentifierList) func(*badger.Txn) error {
...
func CheckSealPayload(height uint64, blockID flow.Identifier, candidateIDs flow.IdentifierList, invalidIDs *map[flow.Identifier]struct{}) func(*badger.Txn) error {
