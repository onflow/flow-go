...
func (_m *Verifier) VerifyRegistersProof(registerIDs [][]byte, stateCommitment ledger.StateCommitment, values [][]byte, proof [][]byte) (bool, error) {
	ret := _m.Called(registerIDs, stateCommitment, values, proof)

	var r0 bool
	if rf, ok := ret.Get(0).(func([][]byte, ledger.StateCommitment, [][]byte, [][]byte) bool); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func([][]byte, ledger.StateCommitment, [][]byte, [][]byte) error); ok {
