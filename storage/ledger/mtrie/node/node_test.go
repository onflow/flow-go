...
func Test_ProperLeaf(t *testing.T) {
	...
	key := uint2binary(56810)
	value := uint2binary(59656)

	n := node.NewLeaf(path, key, value, 0)
...
func Test_InterimNodeWithOneChild(t *testing.T) {
	...
	key := uint2binary(56810)
	value := uint2binary(59656)
	c := node.NewLeaf(path, key, value, 0)
...
func Test_InterimNodeWithBothChildren(t *testing.T) {
	leftChild := node.NewLeaf(uint2binary(56809), uint2binary(56810), uint2binary(59656), 0)
	rightChild := node.NewLeaf(uint2binary(2), uint2binary(11), uint2binary(22), 0)
...
func Test_MaxDepth(t *testing.T) {
	n1 := node.NewLeaf(uint2binary(1), uint2binary(2), uint2binary(3), 0)
	n2 := node.NewLeaf(uint2binary(4), uint2binary(5), uint2binary(6), 0)
	n3 := node.NewLeaf(uint2binary(7), uint2binary(8), uint2binary(9), 0)
