...
// See [ScheduledTransactionsIndex.ByAddress] for full documentation.
//
// Expected error returns during normal operations:
//   - [storage.ErrNotBootstrapped] if the index has not been initialized
...
// All returns an iterator over all scheduled transactions.
// See [ScheduledTransactionsIndex.All] for full documentation.
//
// Expected error returns during normal operations:
//   - [storage.ErrNotBootstrapped] if the index has not been initialized
