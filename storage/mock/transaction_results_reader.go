...
func (_m *TransactionResultsReader) ByBlockID(id flow.Identifier) ([]flow.TransactionResult, error) {
	ret := _m.Called(id)
...
func (_m *TransactionResultsReader) ByBlockIDTransactionID(blockID flow.Identifier, transactionID flow.Identifier) (*flow.TransactionResult, error) {
...
func (_m *TransactionResultsReader) ByBlockIDTransactionIndex(blockID flow.Identifier, txIndex uint32) (*flow.TransactionResult, error) {
