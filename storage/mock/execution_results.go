...
// NewExecutionResults creates a new instance of ExecutionResults. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExecutionResults(t testing.TB) *ExecutionResults {
