...
func (_m *ExecutionResults) ByIDTx(resultID flow.Identifier) func(interface{}) (*flow.ExecutionResult, error) {
	ret := _m.Called(resultID)

	var r0 func(interface{}) (*flow.ExecutionResult, error)
	if rf, ok := ret.Get(0).(func(flow.Identifier) func(interface{}) (*flow.ExecutionResult, error)); ok {
		r0 = rf(resultID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(func(interface{}) (*flow.ExecutionResult, error))
		}
	}
