...
// NewChunksQueue creates a new instance of ChunksQueue. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewChunksQueue(t testing.TB) *ChunksQueue {
	mock := &ChunksQueue{}
	mock.Mock.Test(t)
