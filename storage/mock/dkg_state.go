...
// NewDKGState creates a new instance of DKGState. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDKGState(t testing.TB) *DKGState {
	mock := &DKGState{}
	mock.Mock.Test(t)
