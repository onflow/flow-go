...
// NewEpochStatuses creates a new instance of EpochStatuses. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEpochStatuses(t testing.TB) *EpochStatuses {
	mock := &EpochStatuses{}
	mock.Mock.Test(t)
