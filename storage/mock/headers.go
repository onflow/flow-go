...
// NewHeaders creates a new instance of Headers. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewHeaders(t testing.TB) *Headers {
	mock := &Headers{}
	mock.Mock.Test(t)
