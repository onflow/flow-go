...
func (_m *ConsumerProgress) Halted() (bool, error) {
	ret := _m.Called()
...
// SetHalted provides a mock function with given fields: halted
func (_m *ConsumerProgress) SetHalted(halted bool) error {
	ret := _m.Called(halted)
