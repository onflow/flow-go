...
// ByKeyPrefix provides a mock function for the type RegisterIndexReader
func (_mock *RegisterIndexReader) ByKeyPrefix(keyPrefix string, height uint64, cursor *flow.RegisterID) storage.IndexIterator[flow.RegisterValue, flow.RegisterID] {
...
// RegisterIndexReader_ByKeyPrefix_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ByKeyPrefix'
type RegisterIndexReader_ByKeyPrefix_Call struct {
	*mock.Call
}
...
func (_e *RegisterIndexReader_Expecter) ByKeyPrefix(keyPrefix interface{}, height interface{}, cursor interface{}) *RegisterIndexReader_ByKeyPrefix_Call {
	return &RegisterIndexReader_ByKeyPrefix_Call{Call: _e.mock.On("ByKeyPrefix", keyPrefix, height, cursor)}
}

func (_c *RegisterIndexReader_ByKeyPrefix_Call) Run(run func(keyPrefix string, height uint64, cursor *flow.RegisterID)) *RegisterIndexReader_ByKeyPrefix_Call {
...
func (_c *RegisterIndexReader_ByKeyPrefix_Call) Return(indexIterator storage.IndexIterator[flow.RegisterValue, flow.RegisterID]) *RegisterIndexReader_ByKeyPrefix_Call {
	_c.Call.Return(indexIterator)
	return _c
}

func (_c *RegisterIndexReader_ByKeyPrefix_Call) RunAndReturn(run func(keyPrefix string, height uint64, cursor *flow.RegisterID) storage.IndexIterator[flow.RegisterValue, flow.RegisterID]) *RegisterIndexReader_ByKeyPrefix_Call {
	_c.Call.Return(run)
	return _c
}
