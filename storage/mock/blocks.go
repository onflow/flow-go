...
func (_m *Blocks) GetLastFullBlockHeight() (uint64, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetLastFullBlockHeight")
	}
...
func (_m *Blocks) InsertLastFullBlockHeightIfNotExists(height uint64) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for InsertLastFullBlockHeightIfNotExists")
	}
...
func (_m *Blocks) UpdateLastFullBlockHeight(height uint64) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for UpdateLastFullBlockHeight")
	}
