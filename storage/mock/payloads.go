...
// NewPayloads creates a new instance of Payloads. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPayloads(t testing.TB) *Payloads {
	mock := &Payloads{}
	mock.Mock.Test(t)
