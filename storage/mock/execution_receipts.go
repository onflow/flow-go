...
func (_m *ExecutionReceipts) BatchStore(receipt *flow.ExecutionReceipt, batch storage.WriteBatchContext) error {
...
type mockConstructorTestingTNewExecutionReceipts interface {
	mock.TestingT
	Cleanup(func())
}
