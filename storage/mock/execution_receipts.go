...
// NewExecutionReceipts creates a new instance of ExecutionReceipts. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExecutionReceipts(t testing.TB) *ExecutionReceipts {
