...
// NewEpochSetups creates a new instance of EpochSetups. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEpochSetups(t testing.TB) *EpochSetups {
	mock := &EpochSetups{}
	mock.Mock.Test(t)
