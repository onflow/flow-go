...
// NewLedgerVerifier creates a new instance of LedgerVerifier. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewLedgerVerifier(t testing.TB) *LedgerVerifier {
	mock := &LedgerVerifier{}
	mock.Mock.Test(t)
