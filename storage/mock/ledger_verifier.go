...
func (_m *LedgerVerifier) VerifyRegistersProof(registerIDs []flow.RegisterID, stateCommitment flow.StateCommitment, values []flow.RegisterValue, proof [][]byte) (bool, error) {
	ret := _m.Called(registerIDs, stateCommitment, values, proof)

	var r0 bool
	if rf, ok := ret.Get(0).(func([]flow.RegisterID, flow.StateCommitment, []flow.RegisterValue, [][]byte) bool); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func([]flow.RegisterID, flow.StateCommitment, []flow.RegisterValue, [][]byte) error); ok {
