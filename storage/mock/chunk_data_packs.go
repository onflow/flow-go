...
// NewChunkDataPacks creates a new instance of ChunkDataPacks. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewChunkDataPacks(t testing.TB) *ChunkDataPacks {
	mock := &ChunkDataPacks{}
	mock.Mock.Test(t)
