...
// NewSafeBeaconKeys creates a new instance of SafeBeaconKeys. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewSafeBeaconKeys(t testing.TB) *SafeBeaconKeys {
	mock := &SafeBeaconKeys{}
	mock.Mock.Test(t)
