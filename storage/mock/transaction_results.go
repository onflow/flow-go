...
// NewTransactionResults creates a new instance of TransactionResults. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewTransactionResults(t testing.TB) *TransactionResults {
