...
// NewEpochCommits creates a new instance of EpochCommits. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEpochCommits(t testing.TB) *EpochCommits {
	mock := &EpochCommits{}
	mock.Mock.Test(t)
