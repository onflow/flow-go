...
type Ledger interface {
	...
	UpdateRegisters(registerIDs []flow.RegisterID, values []flow.RegisterValue) (newStateCommitment flow.StateCommitment, err error)
	...
	UpdateRegistersWithProof(registerIDs []flow.RegisterID, values []flow.RegisterValue) (newStateCommitment flow.StateCommitment, proofs []flow.StorageProof, err error)
}
