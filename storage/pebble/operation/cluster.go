...
func LookupClusterBlocksByReferenceHeightRange(start, end uint64, clusterBlockIDs *[]flow.Identifier) func(pebble.Writer) error {
	panic("To implement with traverse")
