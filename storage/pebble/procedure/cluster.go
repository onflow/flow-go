...
// associated indexes.
func InsertClusterBlock(block *cluster.Block) func(operation.PebbleReaderBatchWriter) error {
	return func(rw operation.PebbleReaderBatchWriter) error {
		...
		err = IndexNewBlock(blockID, block.Header.ParentID)(rw)
		if err != nil {
...
func FinalizeClusterBlock(blockID flow.Identifier) func(operation.PebbleReaderBatchWriter) error {
	return func(rw operation.PebbleReaderBatchWriter) error {
