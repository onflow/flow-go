...
func NewEpochProtocolStateEntries(collector module.CacheMetrics,
	...
	retrieveByEntryID := func(r storage.Reader, epochProtocolStateEntryID flow.Identifier) (*flow.RichEpochStateEntry, error) {
		var entry flow.MinEpochStateEntry
		err := operation.RetrieveEpochProtocolState(r, epochProtocolStateEntryID, &entry)
		if err != nil {
			return nil, err
		}
	...
	retrieveByBlockID := func(r storage.Reader, blockID flow.Identifier) (flow.Identifier, error) {
		...
		err := operation.LookupEpochProtocolState(r, blockID, &entryID)
		if err != nil {
...
func (s *EpochProtocolStateEntries) ByID(epochProtocolStateEntryID flow.Identifier) (*flow.RichEpochStateEntry, error) {
	return s.cache.Get(s.db.Reader(), epochProtocolStateEntryID)
}
...
func (s *EpochProtocolStateEntries) ByBlockID(blockID flow.Identifier) (*flow.RichEpochStateEntry, error) {
	epochProtocolStateEntryID, err := s.byBlockIdCache.Get(s.db.Reader(), blockID)
	if err != nil {
