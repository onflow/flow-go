...
type API interface {
	...
	GetAccountBalance(ctx context.Context, address flow.Address) (uint64, error)
	...
	GetAccountKeys(ctx context.Context, address flow.Address) ([]flow.AccountPublicKey, error)
