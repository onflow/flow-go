...
func (_m *API) SendAndSubscribeTransactionStatuses(ctx context.Context, tx *flow.TransactionBody, requiredEventEncodingVersion entities.EventEncodingVersion) subscription_old.Subscription {
...
func (_m *API) SubscribeBlockDigestsFromLatest(ctx context.Context, blockStatus flow.BlockStatus) subscription_old.Subscription {
	...
	var r0 subscription_old.Subscription
	if rf, ok := ret.Get(0).(func(context.Context, flow.BlockStatus) subscription_old.Subscription); ok {
...
func (_m *API) SubscribeBlockDigestsFromStartBlockID(ctx context.Context, startBlockID flow.Identifier, blockStatus flow.BlockStatus) subscription_old.Subscription {
	...
	var r0 subscription_old.Subscription
	if rf, ok := ret.Get(0).(func(context.Context, flow.Identifier, flow.BlockStatus) subscription_old.Subscription); ok {
...
func (_m *API) SubscribeBlockDigestsFromStartHeight(ctx context.Context, startHeight uint64, blockStatus flow.BlockStatus) subscription_old.Subscription {
	...
	var r0 subscription_old.Subscription
	if rf, ok := ret.Get(0).(func(context.Context, uint64, flow.BlockStatus) subscription_old.Subscription); ok {
...
func (_m *API) SubscribeBlockHeadersFromLatest(ctx context.Context, blockStatus flow.BlockStatus) subscription_old.Subscription {
	ret := _m.Called(ctx, blockStatus)
...
func (_m *API) SubscribeBlockHeadersFromStartBlockID(ctx context.Context, startBlockID flow.Identifier, blockStatus flow.BlockStatus) subscription_old.Subscription {
	ret := _m.Called(ctx, startBlockID, blockStatus)
...
func (_m *API) SubscribeBlockHeadersFromStartHeight(ctx context.Context, startHeight uint64, blockStatus flow.BlockStatus) subscription_old.Subscription {
	ret := _m.Called(ctx, startHeight, blockStatus)
...
func (_m *API) SubscribeBlocksFromLatest(ctx context.Context, blockStatus flow.BlockStatus) subscription_old.Subscription {
	ret := _m.Called(ctx, blockStatus)
...
func (_m *API) SubscribeBlocksFromStartBlockID(ctx context.Context, startBlockID flow.Identifier, blockStatus flow.BlockStatus) subscription_old.Subscription {
	ret := _m.Called(ctx, startBlockID, blockStatus)
...
func (_m *API) SubscribeBlocksFromStartHeight(ctx context.Context, startHeight uint64, blockStatus flow.BlockStatus) subscription_old.Subscription {
	ret := _m.Called(ctx, startHeight, blockStatus)
...
func (_m *API) SubscribeTransactionStatuses(ctx context.Context, txID flow.Identifier, requiredEventEncodingVersion entities.EventEncodingVersion) subscription_old.Subscription {
