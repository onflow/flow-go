...
func (_m *API) GetTransactionResult(ctx context.Context, txID flow.Identifier, blockID flow.Identifier, collectionID flow.Identifier, encodingVersion entities.EventEncodingVersion, criteria optimistic_sync.Criteria) (*access.TransactionResult, *access.ExecutorMetadata, error) {
...
func (_m *API) GetTransactionResultByIndex(ctx context.Context, blockID flow.Identifier, index uint32, encodingVersion entities.EventEncodingVersion, criteria optimistic_sync.Criteria) (*access.TransactionResult, *access.ExecutorMetadata, error) {
...
func (_m *API) GetTransactionResultsByBlockID(ctx context.Context, blockID flow.Identifier, encodingVersion entities.EventEncodingVersion, criteria optimistic_sync.Criteria) ([]*access.TransactionResult, *access.ExecutorMetadata, error) {
