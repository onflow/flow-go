...
func (_m *API) SendAndSubscribeTransactionStatuses(ctx context.Context, tx *flow.TransactionBody, requiredEventEncodingVersion entities.EventEncodingVersion) subscription.Subscription[[]*modelaccess.TransactionResult] {
	...
	var r0 subscription.Subscription[[]*modelaccess.TransactionResult]
	if rf, ok := ret.Get(0).(func(context.Context, *flow.TransactionBody, entities.EventEncodingVersion) subscription.Subscription[[]*modelaccess.TransactionResult]); ok {
		r0 = rf(ctx, tx, requiredEventEncodingVersion)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(subscription.Subscription[[]*modelaccess.TransactionResult])
		}
	}
...
func (_m *API) SubscribeBlockDigestsFromLatest(ctx context.Context, blockStatus flow.BlockStatus) subscription.Subscription[*flow.BlockDigest] {
...
func (_m *API) SubscribeBlockDigestsFromStartBlockID(ctx context.Context, startBlockID flow.Identifier, blockStatus flow.BlockStatus) subscription.Subscription[*flow.BlockDigest] {
...
func (_m *API) SubscribeBlockDigestsFromStartHeight(ctx context.Context, startHeight uint64, blockStatus flow.BlockStatus) subscription.Subscription[*flow.BlockDigest] {
...
func (_m *API) SubscribeBlockHeadersFromLatest(ctx context.Context, blockStatus flow.BlockStatus) subscription.Subscription[*flow.Header] {
	ret := _m.Called(ctx, blockStatus)
...
func (_m *API) SubscribeBlockHeadersFromStartBlockID(ctx context.Context, startBlockID flow.Identifier, blockStatus flow.BlockStatus) subscription.Subscription[*flow.Header] {
	ret := _m.Called(ctx, startBlockID, blockStatus)
...
func (_m *API) SubscribeBlockHeadersFromStartHeight(ctx context.Context, startHeight uint64, blockStatus flow.BlockStatus) subscription.Subscription[*flow.Header] {
	ret := _m.Called(ctx, startHeight, blockStatus)
...
func (_m *API) SubscribeBlocksFromLatest(ctx context.Context, blockStatus flow.BlockStatus) subscription.Subscription[*flow.Block] {
	ret := _m.Called(ctx, blockStatus)
...
func (_m *API) SubscribeBlocksFromStartBlockID(ctx context.Context, startBlockID flow.Identifier, blockStatus flow.BlockStatus) subscription.Subscription[*flow.Block] {
	ret := _m.Called(ctx, startBlockID, blockStatus)
...
func (_m *API) SubscribeBlocksFromStartHeight(ctx context.Context, startHeight uint64, blockStatus flow.BlockStatus) subscription.Subscription[*flow.Block] {
	ret := _m.Called(ctx, startHeight, blockStatus)
...
func (_m *API) SubscribeTransactionStatuses(ctx context.Context, txID flow.Identifier, requiredEventEncodingVersion entities.EventEncodingVersion) subscription.Subscription[[]*modelaccess.TransactionResult] {
	...
	var r0 subscription.Subscription[[]*modelaccess.TransactionResult]
	if rf, ok := ret.Get(0).(func(context.Context, flow.Identifier, entities.EventEncodingVersion) subscription.Subscription[[]*modelaccess.TransactionResult]); ok {
