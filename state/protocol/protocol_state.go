...
type MutableProtocolState interface {
	...
	EvolveState(parentBlockID flow.Identifier, candidateView uint64, candidateSeals []*flow.Seal) (stateID flow.Identifier, deferredDBOps *deferred.DeferredBlockPersist, err error)
}
