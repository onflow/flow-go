...
type MutableProtocolState interface {
	...
	EvolveState(parentBlockID flow.Identifier, candidateView uint64, candidateSeals []*flow.Seal) (stateID flow.Identifier, dbUpdates []storage.BlockIndexingBatchWrite, err error)
}
