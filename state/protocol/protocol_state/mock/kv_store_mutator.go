...
func (_m *KVStoreMutator) GetVersionUpgrade() *protocol_state.ViewBasedActivator[uint64] {
	ret := _m.Called()
...
func (_m *KVStoreMutator) SetVersionUpgrade(version *protocol_state.ViewBasedActivator[uint64]) {
	_m.Called(version)
}
