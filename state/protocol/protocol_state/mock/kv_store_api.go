...
func (_m *KVStoreAPI) Replicate(protocolVersion uint64) (protocol_state.KVStoreMutator, transaction.DeferredDBUpdate, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(uint64) (protocol_state.KVStoreMutator, transaction.DeferredDBUpdate, error)); ok {
	...
	if rf, ok := ret.Get(1).(func(uint64) transaction.DeferredDBUpdate); ok {
