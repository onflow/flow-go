...
func (_m *KVStoreAPI) Clone() protocol_state.KVStoreAPI {
	ret := _m.Called()

	var r0 protocol_state.KVStoreAPI
	if rf, ok := ret.Get(0).(func() protocol_state.KVStoreAPI); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_m *KVStoreAPI) SetInvalidEpochTransitionAttempted(attempted bool) error {
...
func (_m *KVStoreAPI) SetVersionUpgrade(version *protocol_state.ViewBasedActivator[uint64]) {
	_m.Called(version)
}
