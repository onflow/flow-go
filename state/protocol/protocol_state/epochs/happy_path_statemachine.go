...
func NewHappyPathStateMachine(consumer protocol_state.StateMachineEventsConsumer, view uint64, parentState *flow.RichEpochProtocolStateEntry) (*HappyPathStateMachine, error) {
