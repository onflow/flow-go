...
// EpochStateMachine is an autogenerated mock type for the EpochStateMachine type
type EpochStateMachine struct {
	mock.Mock
}

// Build provides a mock function with given fields:
func (_m *EpochStateMachine) Build() (*flow.ProtocolStateEntry, flow.Identifier, bool) {
	ret := _m.Called()
...
func (_m *EpochStateMachine) EjectIdentity(nodeID flow.Identifier) error {
...
func (_m *EpochStateMachine) ParentState() *flow.RichProtocolStateEntry {
	ret := _m.Called()
...
func (_m *EpochStateMachine) ProcessEpochCommit(epochCommit *flow.EpochCommit) (bool, error) {
...
func (_m *EpochStateMachine) ProcessEpochSetup(epochSetup *flow.EpochSetup) (bool, error) {
...
func (_m *EpochStateMachine) TransitionToNextEpoch() error {
	ret := _m.Called()
...
func (_m *EpochStateMachine) View() uint64 {
	ret := _m.Called()
...
type mockConstructorTestingTNewEpochStateMachine interface {
	mock.TestingT
	Cleanup(func())
}

// NewEpochStateMachine creates a new instance of EpochStateMachine. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewEpochStateMachine(t mockConstructorTestingTNewEpochStateMachine) *EpochStateMachine {
	mock := &EpochStateMachine{}
	mock.Mock.Test(t)
