...
// NewEpochQuery creates a new instance of EpochQuery. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEpochQuery(t testing.TB) *EpochQuery {
	mock := &EpochQuery{}
	mock.Mock.Test(t)
