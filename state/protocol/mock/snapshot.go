...
// ClusterRootBlock provides a mock function with given fields: _a0
func (_m *Snapshot) ClusterRootBlock(_a0 flow.IdentityList) (*cluster.Block, error) {
	ret := _m.Called(_a0)

	var r0 *cluster.Block
	if rf, ok := ret.Get(0).(func(flow.IdentityList) *cluster.Block); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Snapshot) DKG() protocol.DKG {
	ret := _m.Called()
