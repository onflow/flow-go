...
type mockConstructorTestingTNewEpochProtocolState interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewEpochProtocolState(t mockConstructorTestingTNewEpochProtocolState) *EpochProtocolState {
