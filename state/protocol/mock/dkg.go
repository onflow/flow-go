...
// NewDKG creates a new instance of DKG. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDKG(t testing.TB) *DKG {
	mock := &DKG{}
	mock.Mock.Test(t)
