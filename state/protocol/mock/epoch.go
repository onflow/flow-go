...
// NewEpoch creates a new instance of Epoch. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEpoch(t testing.TB) *Epoch {
	mock := &Epoch{}
	mock.Mock.Test(t)
