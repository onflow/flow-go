...
type State struct {
	...
	epochProtocolStateEntriesDB storage.EpochProtocolStateEntries // TODO remove when EpochMinStateEntry is stored in KVStore
...
func bootstrapEpochForProtocolStateEntry(
	...
	return func(tx *transaction.Tx) error {
		...
		err := operation.SkipDuplicatesTx(epochProtocolStateSnapshots.StoreTx(richEntry.ID(), richEntry.EpochMinStateEntry))(tx)
		if err != nil {
