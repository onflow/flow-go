...
import libp2p "github.com/dapperlabs/flow-go/network/gossip/libp2p"
...
func (_m *Overlay) Handshake(conn libp2p.Connection) (flow.Identifier, error) {
	ret := _m.Called(conn)

	var r0 flow.Identifier
	if rf, ok := ret.Get(0).(func(libp2p.Connection) flow.Identifier); ok {
		r0 = rf(conn)
	} else {
		if ret.Get(0) != nil {
