...
func (_m *Connector) ConnectPeers(ctx context.Context, ids flow.IdentityList) error {
...
func (_m *Connector) DisconnectPeers(ctx context.Context, ids flow.IdentityList) error {
	ret := _m.Called(ctx, ids)
