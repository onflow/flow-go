...
func (u *UnicastAuthorizationTestSuite) setupMiddlewaresAndProviders(slashingViolationsConsumer slashing.ViolationsConsumer) {
	...
	mws, providers := testutils.GenerateMiddlewares(u.T(), ids, libP2PNodes, unittest.NetworkCodec(), testutils.WithSlashingViolationConsumer(slashingViolationsConsumer))
