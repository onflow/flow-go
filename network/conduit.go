...
type Conduit interface {
	...
	Publish(event any, targetIDs ...flow.Identifier) error
	...
	// TODO: function errors must be documented.
	Unicast(event any, targetID flow.Identifier) error
	...
	// TODO: function errors must be documented.
	Multicast(event any, num uint, targetIDs ...flow.Identifier) error
