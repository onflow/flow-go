...
func (m *MockEngine) Process(arg0 channels.Channel, arg1 flow.Identifier, arg2 interface{}) error {
	m.ctrl.T.Helper()
...
func (m *MockEngine) Submit(arg0 channels.Channel, arg1 flow.Identifier, arg2 interface{}) {
	m.ctrl.T.Helper()
