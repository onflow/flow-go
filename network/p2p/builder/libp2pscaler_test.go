...
func TestApplyResourceLimitOverride(t *testing.T) {
	...
	systemOverride := p2pconfig.ResourceManagerOverrideLimit{
...
func TestBuildLibp2pResourceManagerLimits(t *testing.T) {
	...
	requireEqual := func(t *testing.T, override p2pconfig.ResourceManagerOverrideLimit, actual rcmgr.ResourceLimits) {
