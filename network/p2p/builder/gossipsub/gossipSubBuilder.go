...
func NewGossipSubBuilder(logger zerolog.Logger,
	...
	meshTracerCfg := &tracer.GossipSubMeshTracerConfig{
		...
		DuplicateMessageTrackerCacheSize:   gossipSubCfg.RpcTracer.DuplicateMessageTrackerCacheSize,
		DuplicateMessageTrackerGaugeDecay:  gossipSubCfg.RpcTracer.DuplicateMessageTrackerGuageDecay,
	...
	b := &Builder{
		...
		scoreOptionConfig:        scoring.NewScoreOptionConfig(lg, gossipSubCfg.ScoringParameters, metricsCfg.HeroCacheFactory, idProvider, meshTracer.DuplicateMessageCount, networkType),
...
func defaultInspectorSuite(rpcTracker p2p.RpcControlTracking) p2p.GossipSubRpcInspectorSuiteFactoryFunc {
	return func(ctx irrecoverable.SignalerContext,
		logger zerolog.Logger,
		sporkId flow.Identifier,
		inspectorCfg *p2pconfig.RpcInspectorParameters,
