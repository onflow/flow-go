...
func (_m *UnicastManager) Protocols() []protocols.Protocol {
	ret := _m.Called()

	var r0 []protocols.Protocol
	if rf, ok := ret.Get(0).(func() []protocols.Protocol); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]protocols.Protocol)
		}
	}
...
// StreamFactory provides a mock function with given fields:
func (_m *UnicastManager) StreamFactory() stream.Factory {
	ret := _m.Called()

	var r0 stream.Factory
	if rf, ok := ret.Get(0).(func() stream.Factory); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(stream.Factory)
		}
	}
