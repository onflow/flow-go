...
// Execute provides a mock function with given fields: _a0, _a1, _a2, _a3, _a4, _a5
func (_m *CreateNodeFunc) Execute(_a0 zerolog.Logger, _a1 flow.Identifier, _a2 host.Host, _a3 p2p.ProtocolPeerCache, _a4 p2p.PeerManager, _a5 *p2p.DisallowListCacheConfig) p2p.LibP2PNode {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4, _a5)

	var r0 p2p.LibP2PNode
	if rf, ok := ret.Get(0).(func(zerolog.Logger, flow.Identifier, host.Host, p2p.ProtocolPeerCache, p2p.PeerManager, *p2p.DisallowListCacheConfig) p2p.LibP2PNode); ok {
