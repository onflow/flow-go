...
func (n *Node) Subscribe(topic flownet.Topic, codec flownet.Codec, validators ...validator.MessageValidator) (*pubsub.Subscription, error) {
	n.Lock()
	defer n.Unlock()
	...
	var err error
	if !found {
		topicValidator := validator.TopicValidator(n.logger, codec, validators...)
