...
type ConduitSendWrapperFunc func(msg any, conduit network.Conduit, targetIDs ...flow.Identifier) error
...
func (c *ConduitWrapper) Publish(msg any, conduit network.Conduit, targetIDs ...flow.Identifier) error {
...
func (c *ConduitWrapper) Unicast(msg any, conduit network.Conduit, targetIDs ...flow.Identifier) error {
...
func (c *ConduitWrapper) Multicast(msg any, conduit network.Conduit, targetIDs ...flow.Identifier) error {
