...
type UnicastConfig struct {
	...
	// CreateStreamRetryDelay initial delay used in the exponential backoff for create stream retries
	CreateStreamRetryDelay time.Duration `validate:"gt=0s" mapstructure:"unicast-create-stream-retry-delay"`
	...
	MaxStreamCreationRetryAttemptTimes uint64 `validate:"gt=0" mapstructure:"unicast-max-stream-creation-retry-attempt-times"`
}
