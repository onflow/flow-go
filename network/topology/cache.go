...
type Cache struct {
	...
	cachedFanout flow.IdentifierList // most recently generated fanout list by invoking underlying topology.
...
func (c *Cache) GenerateFanout(ids flow.IdentifierList, channels network.ChannelList) (flow.IdentifierList, error) {
	inputIdsFP := flow.MerkleRoot(ids...)
