...
func initializeMessageAuthConfigsMap() {
	...
	AuthorizationConfigs[ChunkDataRequest] = MsgAuthConfig{
		...
		Config: map[channels.Channel]flow.RoleList{
			...
			channels.RequestCollections:       {flow.RoleVerification},
			channels.RequestApprovalsByChunk:  {flow.RoleVerification},
			channels.RequestReceiptsByBlockID: {flow.RoleVerification},
		},
	}
	AuthorizationConfigs[ChunkDataResponse] = MsgAuthConfig{
		...
		Config: map[channels.Channel]flow.RoleList{
			...
			channels.RequestCollections:       {flow.RoleExecution},
	...
	AuthorizationConfigs[ApprovalRequest] = MsgAuthConfig{
		...
		Config: map[channels.Channel]flow.RoleList{
			channels.ProvideApprovalsByChunk: {flow.RoleConsensus},
		},
	}
	...
	AuthorizationConfigs[EntityResponse] = MsgAuthConfig{
		...
		Config: map[channels.Channel]flow.RoleList{
			channels.RequestChunks:            {flow.RoleCollection, flow.RoleExecution},
