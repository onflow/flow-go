...
require (
	...
	github.com/onflow/flow/protobuf/go/flow v0.3.2-0.20230126004846-10cdee27673b
...
replace github.com/onflow/flow/protobuf/go/flow => ../.vendor/flow/protobuf/go/flow
