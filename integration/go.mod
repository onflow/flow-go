...
require (
	...
	github.com/onflow/flow-core-contracts/lib/go/contracts v0.10.1-0.20220202015730-e014d94ed027
	github.com/onflow/flow-core-contracts/lib/go/templates v0.10.0
