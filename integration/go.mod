...
require (
	...
	github.com/onflow/cadence v0.31.5-account-linking-improved-pragma-patch.2
...
replace github.com/onflow/cadence => github.com/dapperlabs/cadence-internal v0.31.6-patch.3
