...
// temporary solution for the issue with
// ambiguous import: found package github.com/btcsuite/btcd/chaincfg/chainhash
replace github.com/btcsuite/btcd => github.com/btcsuite/btcd v0.23.4
