...
require (
	...
	github.com/onflow/cadence v0.42.3
...
replace github.com/onflow/flow-emulator v0.54.1-0.20231024204057-0273f8fe3807 => github.com/AndriiDiachuk/flow-emulator v0.0.0-20231109125242-acdf1bcd9b05
