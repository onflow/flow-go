...
func (suite *Suite) TestProposal_MultiCluster() {

	const (
		nCollectorNodes = 9
		nClusters       = 3
		clusterSize     = nCollectorNodes / nClusters
		nTransactions   = 10
	)

	suite.SetupTest("col_proposal_multicluster", uint(nCollectorNodes), uint(nClusters))
...
func (suite *Suite) TestProposal_Recovery() {
