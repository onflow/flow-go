...
func (w *WintermuteTestSuite) TestWintermuteAttack() {
	...
	receiptB1 := w.ReceiptState.WaitForReceiptFrom(w.T(), victimBlock.ID(), w.corruptedEN1Id)
	...
	receiptB2 := w.ReceiptState.WaitForReceiptFrom(w.T(), victimBlock.ID(), w.corruptedEN2Id)
