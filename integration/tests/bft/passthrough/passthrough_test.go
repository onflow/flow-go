...
// Finally, it evaluates whether critical sealing-and-verification-related events from corrupt nodes are passed through the orchestrator.
func (p *PassThroughTestSuite) TestSealingAndVerificationPassThrough() {
	...
	// as orchestrator controls the corrupt execution and verification nodes, it must see
