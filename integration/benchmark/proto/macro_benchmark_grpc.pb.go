...
const (
	Benchmark_StartMacroBenchmark_FullMethodName = "/benchmark.Benchmark/StartMacroBenchmark"
	Benchmark_GetMacroBenchmark_FullMethodName   = "/benchmark.Benchmark/GetMacroBenchmark"
	Benchmark_ListMacroBenchmarks_FullMethodName = "/benchmark.Benchmark/ListMacroBenchmarks"
	Benchmark_Status_FullMethodName              = "/benchmark.Benchmark/Status"
)
...
func (c *benchmarkClient) StartMacroBenchmark(ctx context.Context, in *StartMacroBenchmarkRequest, opts ...grpc.CallOption) (Benchmark_StartMacroBenchmarkClient, error) {
	stream, err := c.cc.NewStream(ctx, &Benchmark_ServiceDesc.Streams[0], Benchmark_StartMacroBenchmark_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *benchmarkClient) GetMacroBenchmark(ctx context.Context, in *GetMacroBenchmarkRequest, opts ...grpc.CallOption) (*GetMacroBenchmarkResponse, error) {
	...
	err := c.cc.Invoke(ctx, Benchmark_GetMacroBenchmark_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *benchmarkClient) ListMacroBenchmarks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListMacroBenchmarksResponse, error) {
	...
	err := c.cc.Invoke(ctx, Benchmark_ListMacroBenchmarks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *benchmarkClient) Status(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*StatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, Benchmark_Status_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Benchmark_GetMacroBenchmark_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Benchmark_GetMacroBenchmark_FullMethodName,
	}
...
func _Benchmark_ListMacroBenchmarks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Benchmark_ListMacroBenchmarks_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
