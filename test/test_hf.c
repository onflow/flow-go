...
char *tests[4] = {
	TEST1,
	TEST2a TEST2b,				/* Only for SHA-1/224/256. */
	TEST3a TEST3b,
	TEST4a TEST4b				/* Only for SHA-384/512. */
};

long int count[4] = { 1, 1, 10000, 1 };

unsigned char result1[4][20] = {
...
int sha1(void) {
	int code = STS_ERR;
	int i, j;
	unsigned char message[1000001], digest[20];
...
int sha224(void) {
	int code = STS_ERR;
	int i, j;
	unsigned char message[1000001], digest[28];
...
int sha256(void) {
	int code = STS_ERR;
	int i, j;
	unsigned char message[1000001], digest[32];
...
int sha384(void) {
	int code = STS_ERR;
	int i, j;
	unsigned char message[1000001], digest[48];
...
int sha512(void) {
	int code = STS_ERR;
	int i, j;
	unsigned char message[1000001], digest[64];
