...
func NewForks(final *flow.Header, headers storage.Headers, updater module.Finalizer, notifier hotstuff.ConsensusFollowerConsumer, rootHeader *flow.Header, rootQC *flow.QuorumCertificate) (*forks.Forks, error) {
