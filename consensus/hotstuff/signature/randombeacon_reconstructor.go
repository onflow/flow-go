...
func NewRandomBeaconReconstructurImpl(dkg hotstuff.DKG, identity2SignerIndex map[flow.Identifier]int, randomBeaconSigner hotstuff.RandomBeaconSigner) *RandomBeaconReconstructorImpl {
