...
type SigVerifier interface {
	...
	VerifyStakingSig(stakingSig crypto.Signature, block *model.Block, signerKey crypto.PublicKey) (bool, error)
	...
	VerifyRandomBeaconSig(sigShare crypto.Signature, block *model.Block, signerPubKey crypto.PublicKey) (bool, error)
	...
	VerifyStakingAggregatedSig(aggStakingSig []crypto.Signature, block *model.Block, signerKeys []crypto.PublicKey) (bool, error)
	...
	VerifyRandomBeaconThresholdSig(sig crypto.Signature, block *model.Block, groupPubKey crypto.PublicKey) (bool, error)
}
