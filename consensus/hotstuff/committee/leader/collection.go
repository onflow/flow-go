...
func NewSelectionForCollection(count int, rootHeader *flow.Header, rootQC *flow.QuorumCertificate, state protocol.State, clusterRootHeader *flow.Header, clusterState cluster.State, clusterIndex uint) (*committee.LeaderSelection, error) {
