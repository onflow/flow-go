...
// NewEventLoop creates a new instance of EventLoop. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEventLoop(t testing.TB) *EventLoop {
	mock := &EventLoop{}
	mock.Mock.Test(t)
