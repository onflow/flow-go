...
// NewVoteCollectors creates a new instance of VoteCollectors. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewVoteCollectors(t testing.TB) *VoteCollectors {
	mock := &VoteCollectors{}
	mock.Mock.Test(t)
