...
func (_m *CommunicatorConsumer) OnOwnProposal(proposal *flow.ProposalHeader, targetPublicationTime time.Time) {
...
func (_m *CommunicatorConsumer) OnOwnVote(vote *model.Vote, recipientID flow.Identifier) {
