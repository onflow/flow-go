...
// NewBlockSignerDecoder creates a new instance of BlockSignerDecoder. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewBlockSignerDecoder(t testing.TB) *BlockSignerDecoder {
