...
// NewWeightedSignatureAggregator creates a new instance of WeightedSignatureAggregator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewWeightedSignatureAggregator(t testing.TB) *WeightedSignatureAggregator {
