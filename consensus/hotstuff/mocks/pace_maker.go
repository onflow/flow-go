...
// NewPaceMaker creates a new instance of PaceMaker. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewPaceMaker(t testing.TB) *PaceMaker {
	mock := &PaceMaker{}
	mock.Mock.Test(t)
