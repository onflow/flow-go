...
// NewForks creates a new instance of Forks. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewForks(t testing.TB) *Forks {
	mock := &Forks{}
	mock.Mock.Test(t)
