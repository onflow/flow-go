...
// NewEventHandler creates a new instance of EventHandler. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEventHandler(t testing.TB) *EventHandler {
	mock := &EventHandler{}
	mock.Mock.Test(t)
