...
// ProduceTimeout provides a mock function with given fields: curView, highestQC, lastViewTC
func (_m *SafetyRules) ProduceTimeout(curView uint64, highestQC *flow.QuorumCertificate, lastViewTC *flow.TimeoutCertificate) (*model.TimeoutObject, error) {
