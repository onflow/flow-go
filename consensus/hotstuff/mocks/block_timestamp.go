...
// BlockTimestamp is an autogenerated mock type for the BlockTimestamp type
type BlockTimestamp struct {
	mock.Mock
}

// Build provides a mock function with given fields: parentTimestamp
func (_m *BlockTimestamp) Build(parentTimestamp time.Time) time.Time {
...
func (_m *BlockTimestamp) Validate(parentTimestamp time.Time, currentTimestamp time.Time) error {
