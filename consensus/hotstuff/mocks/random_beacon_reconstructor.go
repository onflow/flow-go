...
// NewRandomBeaconReconstructor creates a new instance of RandomBeaconReconstructor. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRandomBeaconReconstructor(t testing.TB) *RandomBeaconReconstructor {
