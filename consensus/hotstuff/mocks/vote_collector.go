...
// NewVoteCollector creates a new instance of VoteCollector. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewVoteCollector(t testing.TB) *VoteCollector {
	mock := &VoteCollector{}
	mock.Mock.Test(t)
