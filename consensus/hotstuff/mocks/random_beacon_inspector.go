...
// NewRandomBeaconInspector creates a new instance of RandomBeaconInspector. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewRandomBeaconInspector(t testing.TB) *RandomBeaconInspector {
