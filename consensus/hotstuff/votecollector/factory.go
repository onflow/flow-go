...
func NewStakingVoteProcessorFactory(committee hotstuff.VoterCommittee, onQCCreated hotstuff.OnQCCreated) *VoteProcessorFactory {
...
func NewCombinedVoteProcessorFactory(committee hotstuff.VoterCommittee, onQCCreated hotstuff.OnQCCreated) *VoteProcessorFactory {
...
func NewBootstrapCombinedVoteProcessor(log zerolog.Logger, committee hotstuff.VoterCommittee, block *model.Block, onQCCreated hotstuff.OnQCCreated) (hotstuff.VerifyingVoteProcessor, error) {
...
// Intended use: only for bootstrapping.
// UNSAFE: the proposer vote for `block` is _not_ validated or included
func NewBootstrapStakingVoteProcessor(log zerolog.Logger, committee hotstuff.VoterCommittee, block *model.Block, onQCCreated hotstuff.OnQCCreated) (hotstuff.VerifyingVoteProcessor, error) {
