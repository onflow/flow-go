...
// DKGPublicData provides a mock function with given fields:
func (_m *ViewState) DKGPublicData() *hotstuff.DKGPublicData {
	ret := _m.Called()

	var r0 *hotstuff.DKGPublicData
	if rf, ok := ret.Get(0).(func() *hotstuff.DKGPublicData); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*hotstuff.DKGPublicData)
		}
	}
