...
func (w BlockBuilderMetricsWrapper) BuildOn(parentID flow.Identifier, setter func(*flow.HeaderBuilder) error, sign func(*flow.Header) ([]byte, error)) (*flow.ProposalHeader, error) {
