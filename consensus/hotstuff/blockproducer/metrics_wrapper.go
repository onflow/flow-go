...
func (w BlockBuilderMetricsWrapper) BuildOn(parentID flow.Identifier, setter func(*flow.HeaderBodyBuilder) error, sign func(*flow.UnsignedHeader) ([]byte, error)) (*flow.ProposalHeader, error) {
