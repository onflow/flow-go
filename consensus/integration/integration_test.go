...
type BlockOrDelayFunc func(channel channels.Channel, event any, sender, receiver *Node) (bool, time.Duration)
...
func blockNothing(_ channels.Channel, _ any, _, _ *Node) (bool, time.Duration) {
	return false, 0
}
