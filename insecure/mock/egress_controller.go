...
// NewEgressController creates a new instance of EgressController. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEgressController(t testing.TB) *EgressController {
