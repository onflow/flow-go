...
// NewCorruptibleConduitFactory_ConnectAttackerServer creates a new instance of CorruptibleConduitFactory_ConnectAttackerServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCorruptibleConduitFactory_ConnectAttackerServer(t testing.TB) *CorruptibleConduitFactory_ConnectAttackerServer {
