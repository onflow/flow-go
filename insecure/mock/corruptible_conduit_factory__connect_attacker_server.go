...
type mockConstructorTestingTNewCorruptibleConduitFactory_ConnectAttackerServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCorruptibleConduitFactory_ConnectAttackerServer(t mockConstructorTestingTNewCorruptibleConduitFactory_ConnectAttackerServer) *CorruptibleConduitFactory_ConnectAttackerServer {
