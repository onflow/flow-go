...
type mockConstructorTestingTNewCorruptibleConduitFactory_ProcessAttackerMessageServer interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCorruptibleConduitFactory_ProcessAttackerMessageServer(t mockConstructorTestingTNewCorruptibleConduitFactory_ProcessAttackerMessageServer) *CorruptibleConduitFactory_ProcessAttackerMessageServer {
