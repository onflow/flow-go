...
type mockConstructorTestingTNewCorruptibleConduitFactory interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCorruptibleConduitFactory(t mockConstructorTestingTNewCorruptibleConduitFactory) *CorruptibleConduitFactory {
