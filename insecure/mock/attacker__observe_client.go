...
// NewAttacker_ObserveClient creates a new instance of Attacker_ObserveClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAttacker_ObserveClient(t testing.TB) *Attacker_ObserveClient {
