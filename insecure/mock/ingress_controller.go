...
func (_m *IngressController) HandleIncomingEvent(_a0 channels.Channel, _a1 flow.Identifier, _a2 interface{}) bool {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 bool
	if rf, ok := ret.Get(0).(func(channels.Channel, flow.Identifier, interface{}) bool); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		r0 = ret.Get(0).(bool)
	}
