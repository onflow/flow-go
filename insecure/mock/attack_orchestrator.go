...
// NewAttackOrchestrator creates a new instance of AttackOrchestrator. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAttackOrchestrator(t testing.TB) *AttackOrchestrator {
