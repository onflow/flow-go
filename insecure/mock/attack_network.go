...
func (_m *AttackNetwork) SendEgress(_a0 *insecure.EgressEvent) error {
	ret := _m.Called(_a0)
...
type mockConstructorTestingTNewAttackNetwork interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAttackNetwork(t mockConstructorTestingTNewAttackNetwork) *AttackNetwork {
	mock := &AttackNetwork{}
	mock.Mock.Test(t)
