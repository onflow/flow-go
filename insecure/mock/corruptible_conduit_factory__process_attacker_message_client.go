...
type mockConstructorTestingTNewCorruptibleConduitFactory_ProcessAttackerMessageClient interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewCorruptibleConduitFactory_ProcessAttackerMessageClient(t mockConstructorTestingTNewCorruptibleConduitFactory_ProcessAttackerMessageClient) *CorruptibleConduitFactory_ProcessAttackerMessageClient {
