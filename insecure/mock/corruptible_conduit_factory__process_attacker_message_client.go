...
// NewCorruptibleConduitFactory_ProcessAttackerMessageClient creates a new instance of CorruptibleConduitFactory_ProcessAttackerMessageClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCorruptibleConduitFactory_ProcessAttackerMessageClient(t testing.TB) *CorruptibleConduitFactory_ProcessAttackerMessageClient {
	mock := &CorruptibleConduitFactory_ProcessAttackerMessageClient{}
	mock.Mock.Test(t)
