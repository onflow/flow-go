...
type NewAttackerServerT interface {
	mock.TestingT
	Cleanup(func())
}

// NewAttackerServer creates a new instance of AttackerServer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewAttackerServer(t NewAttackerServerT) *AttackerServer {
	mock := &AttackerServer{}
	mock.Mock.Test(t)
