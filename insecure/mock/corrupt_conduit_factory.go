...
func (_m *CorruptConduitFactory) Done() <-chan struct{} {
	ret := _m.Called()
...
func (_m *CorruptConduitFactory) Ready() <-chan struct{} {
	ret := _m.Called()
...
func (_m *CorruptConduitFactory) Start(_a0 irrecoverable.SignalerContext) {
	_m.Called(_a0)
}
