...
// NewCorruptibleConduitFactory_ConnectAttackerClient creates a new instance of CorruptibleConduitFactory_ConnectAttackerClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCorruptibleConduitFactory_ConnectAttackerClient(t testing.TB) *CorruptibleConduitFactory_ConnectAttackerClient {
