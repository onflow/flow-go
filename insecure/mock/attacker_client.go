...
type NewAttackerClientT interface {
	mock.TestingT
	Cleanup(func())
}

// NewAttackerClient creates a new instance of AttackerClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewAttackerClient(t NewAttackerClientT) *AttackerClient {
	mock := &AttackerClient{}
	mock.Mock.Test(t)
