...
func TestBugOnTestnet(t *testing.T) {
	...
	dir := "/Users/alex/Projects/Flow/2021-11-15 MTrie_issue/debugpack"
	// download: https://console.cloud.google.com/storage/browser/_details/flow-research-data/trie_bug/debugpack.zip;tab=live_object?project=dl-flow
