...
// NewReporter creates a new instance of Reporter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewReporter(t testing.TB) *Reporter {
	mock := &Reporter{}
	mock.Mock.Test(t)
