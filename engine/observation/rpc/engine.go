...
func New(log zerolog.Logger, config Config, e *ingestion.Engine, collectionRPC observation.ObserveServiceClient, executionRPC observation.ObserveServiceClient) *Engine {
