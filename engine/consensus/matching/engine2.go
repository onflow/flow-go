...
// Engine2 is a wrapper for matching `Engine` which implements logic for
...
// them to `Engine`. Engine2 runs 2 separate gorourtines that perform pre-processing and consuming messages by Engine.
type Engine2 struct {
	unit                                 *engine.Unit
	log                                  zerolog.Logger
	me                                   module.Local
...
func NewEngine(log zerolog.Logger,
	...
	requiredApprovalsForSealConstruction uint,
	emergencySealingActive bool) (*Engine2, error) {
	e := &Engine2{
		unit:                                 engine.NewUnit(),
		log:                                  log,
		me:                                   me,
...
func (e *Engine2) Process(originID flow.Identifier, event interface{}) error {
...
func (e *Engine2) processPendingEvent(event *Event) {
...
func (e *Engine2) consumeEvents() {
	...
	for {
		...
		if err != nil {
			// Public methods of `Engine` are supposed to handle all errors internally.
...
func (e *Engine2) SubmitLocal(event interface{}) {
...
func (e *Engine2) Submit(originID flow.Identifier, event interface{}) {
...
func (e *Engine2) ProcessLocal(event interface{}) error {
...
// engine constructor.
func (e *Engine2) HandleReceipt(originID flow.Identifier, receipt flow.Entity) {
...
// upon initialization.
func (e *Engine2) Ready() <-chan struct{} {
...
func (e *Engine2) Done() <-chan struct{} {
	return e.unit.Done()
}
