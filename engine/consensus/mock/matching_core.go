...
// NewMatchingCore creates a new instance of MatchingCore. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewMatchingCore(t testing.TB) *MatchingCore {
	mock := &MatchingCore{}
	mock.Mock.Test(t)
