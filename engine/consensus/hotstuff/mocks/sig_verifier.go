...
func (_m *SigVerifier) VerifyRandomBeaconSig(sigShare crypto.Signature, block *hotstuff.Block, signerPubKey crypto.PublicKey) (bool, error) {
	ret := _m.Called(sigShare, block, signerPubKey)

	var r0 bool
	if rf, ok := ret.Get(0).(func(crypto.Signature, *hotstuff.Block, crypto.PublicKey) bool); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(crypto.Signature, *hotstuff.Block, crypto.PublicKey) error); ok {
...
func (_m *SigVerifier) VerifyRandomBeaconThresholdSig(sig crypto.Signature, block *hotstuff.Block, groupPubKey crypto.PublicKey) (bool, error) {
...
func (_m *SigVerifier) VerifyStakingAggregatedSig(aggStakingSig []crypto.Signature, block *hotstuff.Block, signerKeys []crypto.PublicKey) (bool, error) {
...
func (_m *SigVerifier) VerifyStakingSig(stakingSig crypto.Signature, block *hotstuff.Block, signerKey crypto.PublicKey) (bool, error) {
