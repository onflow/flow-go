...
import (
	...
	mockn "github.com/dapperlabs/flow-go/engine/consensus/hotstuff/notifications/mock"
...
func addBlocksToFinalizer(fin forks.Finalizer, blocks []*hotstuff.Block) error {
