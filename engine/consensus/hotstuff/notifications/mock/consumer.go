...
import (
	...
	types "github.com/dapperlabs/flow-go/engine/consensus/hotstuff/types"
)
...
func (_m *Consumer) OnDoubleVotingDetected(_a0 *types.Vote, _a1 *types.Vote) {
	_m.Called(_a0, _a1)
}
...
func (_m *Consumer) OnInvalidVoteDetected(_a0 *types.Vote) {
	_m.Called(_a0)
}
