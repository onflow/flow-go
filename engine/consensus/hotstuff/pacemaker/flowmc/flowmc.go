...
import (
	"github.com/dapperlabs/flow-go/engine/consensus/hotstuff/pacemaker/events"
...
func New(id types.ID, view uint64, primarySelector primary.Selector, eventProc events.Processor) *FlowMC {
	if view < 1 {
