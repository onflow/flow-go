...
func (s *ApprovalCollectorTestSuite) SetupTest() {
	...
	s.collector = NewApprovalCollector(s.IncorporatedResult, &s.IncorporatedBlock, &s.IncorporatedBlock, s.ChunksAssignment, s.sealsPL, uint(len(s.AuthorizedVerifiers)))
}
