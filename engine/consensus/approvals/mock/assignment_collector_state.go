...
// NewAssignmentCollectorState creates a new instance of AssignmentCollectorState. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAssignmentCollectorState(t testing.TB) *AssignmentCollectorState {
