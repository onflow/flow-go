...
// NewAssignmentCollector creates a new instance of AssignmentCollector. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAssignmentCollector(t testing.TB) *AssignmentCollector {
