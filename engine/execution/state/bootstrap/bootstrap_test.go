...
func TestBootstrapLedger_ZeroTokenSupply(t *testing.T) {
	var expectedStateCommitmentBytes, _ = hex.DecodeString("8e16c6bb5a42a4bcbd01d156c7d6f4b4cd2f37bcd2bdf5779338b2d9585eaab5")
	var expectedStateCommitment flow.StateCommitment
	copy(expectedStateCommitment[:], expectedStateCommitmentBytes)
