...
// AttestationStorage is an autogenerated mock type for the AttestationStorage type
type AttestationStorage struct {
	mock.Mock
}

// ChunkDataPackByChunkID provides a mock function with given fields: _a0
func (_m *AttestationStorage) ChunkDataPackByChunkID(_a0 flow.Identifier) (*flow.ChunkDataPack, error) {
	ret := _m.Called(_a0)
...
func (_m *AttestationStorage) Done() <-chan struct{} {
	ret := _m.Called()
...
func (_m *AttestationStorage) GetBlockIDByChunkID(chunkID flow.Identifier) (flow.Identifier, error) {
...
func (_m *AttestationStorage) GetExecutionResultID(_a0 context.Context, _a1 flow.Identifier) (flow.Identifier, error) {
...
func (_m *AttestationStorage) GetHighestExecutedBlockID(_a0 context.Context) (uint64, flow.Identifier, error) {
	ret := _m.Called(_a0)
...
func (_m *AttestationStorage) HasState(_a0 flow.StateCommitment) bool {
	ret := _m.Called(_a0)
...
func (_m *AttestationStorage) OnBlockExecuted(block *flow.Header, _a1 delta.SpockSnapshot) error {
...
func (_m *AttestationStorage) OnFinalizedBlock(block *flow.Header) {
	_m.Called(block)
}

// OnSealedBlock provides a mock function with given fields: block
func (_m *AttestationStorage) OnSealedBlock(block *flow.Header) {
	_m.Called(block)
}

// Ready provides a mock function with given fields:
func (_m *AttestationStorage) Ready() <-chan struct{} {
	ret := _m.Called()
...
func (_m *AttestationStorage) SaveExecutionResults(ctx context.Context, result *execution.ComputationResult, executionReceipt *flow.ExecutionReceipt) error {
...
func (_m *AttestationStorage) StateCommitmentByBlockID(_a0 context.Context, _a1 flow.Identifier) (flow.StateCommitment, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *AttestationStorage) UpdateHighestExecutedBlockIfHigher(_a0 context.Context, _a1 *flow.Header) error {
	ret := _m.Called(_a0, _a1)
...
type mockConstructorTestingTNewAttestationStorage interface {
	mock.TestingT
	Cleanup(func())
}

// NewAttestationStorage creates a new instance of AttestationStorage. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewAttestationStorage(t mockConstructorTestingTNewAttestationStorage) *AttestationStorage {
	mock := &AttestationStorage{}
	mock.Mock.Test(t)
