...
func (_m *ReadOnlyExecutionState) NewStorageSnapshot(_a0 flow.StateCommitment) storagestate.StorageSnapshot {
	ret := _m.Called(_a0)

	var r0 storagestate.StorageSnapshot
	if rf, ok := ret.Get(0).(func(flow.StateCommitment) storagestate.StorageSnapshot); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(storagestate.StorageSnapshot)
		}
	}
