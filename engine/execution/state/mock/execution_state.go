...
func (_m *ExecutionState) ChunkDataPackByChunkID(_a0 context.Context, _a1 flow.Identifier) (*storagemodel.StoredChunkDataPack, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *storagemodel.StoredChunkDataPack
	if rf, ok := ret.Get(0).(func(context.Context, flow.Identifier) *storagemodel.StoredChunkDataPack); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *ExecutionState) PersistExecutionState(ctx context.Context, header *flow.Header, endState flow.StateCommitment, chunkDataPacks []*storagemodel.StoredChunkDataPack, executionReceipt *flow.ExecutionReceipt, events []flow.EventsList, serviceEvents flow.EventsList, results []flow.TransactionResult) error {
	ret := _m.Called(ctx, header, endState, chunkDataPacks, executionReceipt, events, serviceEvents, results)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *flow.Header, flow.StateCommitment, []*storagemodel.StoredChunkDataPack, *flow.ExecutionReceipt, []flow.EventsList, flow.EventsList, []flow.TransactionResult) error); ok {
