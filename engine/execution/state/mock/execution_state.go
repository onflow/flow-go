...
// RetrieveStateViews provides a mock function with given fields: blockID
func (_m *ExecutionState) RetrieveStateViews(blockID flow.Identifier) ([]*delta.View, error) {
	ret := _m.Called(blockID)

	var r0 []*delta.View
	if rf, ok := ret.Get(0).(func(flow.Identifier) []*delta.View); ok {
		r0 = rf(blockID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*delta.View)
