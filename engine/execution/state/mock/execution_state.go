...
func (_m *ExecutionState) GetRegisters(_a0 context.Context, _a1 flow.StateCommitment, _a2 []flow.RegisterID) ([]flow.RegisterValue, error) {
	ret := _m.Called(_a0, _a1, _a2)
...
func (_m *ExecutionState) GetRegistersWithProofs(_a0 context.Context, _a1 flow.StateCommitment, _a2 []flow.RegisterID) ([]flow.RegisterValue, [][]byte, error) {
	ret := _m.Called(_a0, _a1, _a2)
