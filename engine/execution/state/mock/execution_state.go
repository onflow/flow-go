...
// NewExecutionState creates a new instance of ExecutionState. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExecutionState(t testing.TB) *ExecutionState {
	mock := &ExecutionState{}
	mock.Mock.Test(t)
