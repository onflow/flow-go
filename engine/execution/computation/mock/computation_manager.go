...
// RetryUpload provides a mock function with given fields:
func (_m *ComputationManager) RetryUpload() error {
	ret := _m.Called()
...
type NewComputationManagerT interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewComputationManager(t NewComputationManagerT) *ComputationManager {
