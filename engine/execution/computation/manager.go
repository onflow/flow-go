...
func DefaultFVMOptions(chainID flow.ChainID, extensiveTracing bool, scheduledTransactionsEnabled bool) []fvm.Option {
	options := []fvm.Option{
		...
		fvm.WithScheduledTransactionsEnabled(scheduledTransactionsEnabled),
	}
