...
func (_m *BlockComputer) ExecuteBlock(_a0 context.Context, _a1 *entity.ExecutableBlock, _a2 state.View, _a3 *fvm.Programs) (*execution.ComputationResult, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 *execution.ComputationResult
	if rf, ok := ret.Get(0).(func(context.Context, *entity.ExecutableBlock, state.View, *fvm.Programs) *execution.ComputationResult); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *entity.ExecutableBlock, state.View, *fvm.Programs) error); ok {
