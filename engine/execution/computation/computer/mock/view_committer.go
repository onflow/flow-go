...
// NewViewCommitter creates a new instance of ViewCommitter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewViewCommitter(t testing.TB) *ViewCommitter {
	mock := &ViewCommitter{}
	mock.Mock.Test(t)
