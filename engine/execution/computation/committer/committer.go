...
func (committer *LedgerViewCommitter) collectProofs(
	...
	// Why the proof must include AllRegisterIDs instead of ReadRegisterIDs?
	...
	// able to derive the same trie root hash of the execution state post execution. That's why
	// the storage proof needs both read registers and write registers, which especially is AllRegisterIDs
