...
func (_m *ExtendableStorageSnapshot) Extend(newCommit flow.StateCommitment, updatedRegisters map[flow.RegisterID]flow.RegisterValue) execution.ExtendableStorageSnapshot {
	...
	if rf, ok := ret.Get(0).(func(flow.StateCommitment, map[flow.RegisterID]flow.RegisterValue) execution.ExtendableStorageSnapshot); ok {
...
func (_m *ExtendableStorageSnapshot) Get(id flow.RegisterID) (flow.RegisterValue, error) {
	ret := _m.Called(id)
