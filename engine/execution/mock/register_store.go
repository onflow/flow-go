...
func (_m *RegisterStore) SaveRegisters(header *flow.UnsignedHeader, registers flow.RegisterEntries) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*flow.UnsignedHeader, flow.RegisterEntries) error); ok {
