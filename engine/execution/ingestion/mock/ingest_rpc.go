...
// NewIngestRPC creates a new instance of IngestRPC. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewIngestRPC(t testing.TB) *IngestRPC {
	mock := &IngestRPC{}
	mock.Mock.Test(t)
