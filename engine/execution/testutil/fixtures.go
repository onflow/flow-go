...
func ComputationResultFixture(t *testing.T) *execution.ComputationResult {
	...
	blockExecResult.CollectionExecutionResultAt(0).AppendTransactionResults(
		flow.EventsList{
			unittest.EventFixture("what", 0, 0, unittest.IdentifierFixture(), []byte{}),
			unittest.EventFixture("ever", 0, 1, unittest.IdentifierFixture(), []byte{}),
		},
		nil,
		nil,
	...
	blockExecResult.CollectionExecutionResultAt(1).AppendTransactionResults(
		flow.EventsList{
			unittest.EventFixture("what", 2, 0, unittest.IdentifierFixture(), []byte{}),
			unittest.EventFixture("ever", 2, 1, unittest.IdentifierFixture(), []byte{}),
			unittest.EventFixture("ever", 2, 2, unittest.IdentifierFixture(), []byte{}),
			unittest.EventFixture("ever", 2, 3, unittest.IdentifierFixture(), []byte{}),
		},
		nil,
		nil,
		flow.TransactionResult{
