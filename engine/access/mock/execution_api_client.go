...
// NewExecutionAPIClient creates a new instance of ExecutionAPIClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExecutionAPIClient(t testing.TB) *ExecutionAPIClient {
