...
// NewAccessAPIClient creates a new instance of AccessAPIClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAccessAPIClient(t testing.TB) *AccessAPIClient {
