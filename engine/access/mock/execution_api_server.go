...
// NewExecutionAPIServer creates a new instance of ExecutionAPIServer. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExecutionAPIServer(t testing.TB) *ExecutionAPIServer {
