...
func (b *backendScripts) executeScriptLocally(
	...
	result, compUsed, err := b.scriptExecutor.ExecuteAtBlockHeight(ctx, r.script, r.arguments, r.height)
	...
	lg := b.log.With().
		...
		Uint64("computation_used", compUsed).
	...
	if err != nil {
		...
		return nil, compUsed, execDuration, convertedErr
	}
	...
	return result, compUsed, execDuration, nil
}
...
func (b *backendScripts) tryExecuteScriptOnExecutionNode(
	...
	return execResp.GetValue(), execResp.ComputationUsage, nil
}
