...
func DefaultSystemCollection(chainID flow.ChainID) (*SystemCollection, error) {
...
// SystemTx returns the transaction body of the system transaction.
// This is the last transaction in the system collection, which is responsible for protocol management.
func (s *SystemCollection) SystemTx() *flow.TransactionBody {
	return s.lookup[s.systemTxID]
}
