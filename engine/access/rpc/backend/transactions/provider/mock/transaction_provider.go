...
// TransactionResult provides a mock function with given fields: ctx, header, txID, collectionID, encodingVersion, criteria
func (_m *TransactionProvider) TransactionResult(ctx context.Context, header *flow.Header, txID flow.Identifier, collectionID flow.Identifier, encodingVersion entities.EventEncodingVersion, criteria optimistic_sync.Criteria) (*access.TransactionResult, error) {
	ret := _m.Called(ctx, header, txID, collectionID, encodingVersion, criteria)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *flow.Header, flow.Identifier, flow.Identifier, entities.EventEncodingVersion, optimistic_sync.Criteria) (*access.TransactionResult, error)); ok {
		return rf(ctx, header, txID, collectionID, encodingVersion, criteria)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *flow.Header, flow.Identifier, flow.Identifier, entities.EventEncodingVersion, optimistic_sync.Criteria) *access.TransactionResult); ok {
		r0 = rf(ctx, header, txID, collectionID, encodingVersion, criteria)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *flow.Header, flow.Identifier, flow.Identifier, entities.EventEncodingVersion, optimistic_sync.Criteria) error); ok {
		r1 = rf(ctx, header, txID, collectionID, encodingVersion, criteria)
	} else {
		r1 = ret.Error(1)
	}
