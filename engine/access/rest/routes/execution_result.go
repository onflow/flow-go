...
func GetExecutionResultsByBlockIDs(r *request.Request, srv api.RestServerApi, link models.LinkGenerator) (interface{}, error) {
...
func GetExecutionResultByID(r *request.Request, srv api.RestServerApi, link models.LinkGenerator) (interface{}, error) {
