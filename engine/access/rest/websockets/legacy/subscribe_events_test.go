...
//			require.NoError(s.T(), err)
//			respRecorder := routes.newTestHijackResponseRecorder()
//			// closing the connection after 1 second
//			go func() {
//				time.Sleep(1 * time.Second)
//				respRecorder.Close()
//			}()
//			routes.executeWsRequest(req, stateStreamBackend, respRecorder, chainID.Chain())
...
//		q.Add(routes.startBlockIdQueryParam, startBlockId.String())
//	}
//
//	if startHeight != request.EmptyHeight {
//		q.Add(routes.startHeightQueryParam, fmt.Sprintf("%d", startHeight))
//	}
//
//	if len(eventTypes) > 0 {
//		q.Add(routes.eventTypesQueryParams, strings.Join(eventTypes, ","))
//	}
//	if len(addresses) > 0 {
//		q.Add(routes.addressesQueryParams, strings.Join(addresses, ","))
//	}
//	if len(contracts) > 0 {
//		q.Add(routes.contractsQueryParams, strings.Join(contracts, ","))
//	}
//
//	q.Add(routes.heartbeatIntervalQueryParam, fmt.Sprintf("%d", heartbeatInterval))
//
//	u.RawQuery = q.Encode()
...
//}
//
//func requireError(t *testing.T, recorder *routes.testHijackResponseRecorder, expected string) {
//	<-recorder.closed
...
//func requireResponse(t *testing.T, recorder *routes.testHijackResponseRecorder, expected []*backend.EventsResponse) {
//	<-recorder.closed
