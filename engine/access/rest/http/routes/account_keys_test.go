...
//	"github.com/onflow/flow-go/common/unittest"
//)
//
...
//
//		req := getAccountKeyByIndexRequest(t, account, "0", common.sealedHeightQueryParam)
//
//		backend.Mock.
...
//
//		common.assertOKResponse(t, req, expected, backend)
...
//		keyByIndex := findAccountKeyByIndex(account.Keys, keyIndex)
//
//		req := getAccountKeyByIndexRequest(t, account, "0", common.finalHeightQueryParam)
//
//		backend.Mock.
...
//		block := unittest.BlockHeaderFixture(unittest.WithHeaderHeight(height))
//
//		req := getAccountKeyByIndexRequest(t, account, index, common.sealedHeightQueryParam)
//
//		backend.Mock.
//			On("GetLatestBlockHeader", mocktestify.Anything, true).
//			Return(block, flow.BlockStatusSealed, nil)
...
//
//		common.assertResponse(t, req, statusCode, expected, backend)
//		mocktestify.AssertExpectationsForObjects(t, backend)
//	})
//
...
//		block := unittest.BlockHeaderFixture(unittest.WithHeaderHeight(height))
//
//		req := getAccountKeyByIndexRequest(t, account, index, common.finalHeightQueryParam)
//
//		backend.Mock.
//			On("GetLatestBlockHeader", mocktestify.Anything, false).
//			Return(block, flow.BlockStatusFinalized, nil)
...
//			rr := common.executeRequest(req, backend)
...
//		block := unittest.BlockHeaderFixture(unittest.WithHeaderHeight(height))
//
//		req := getAccountKeysRequest(t, account, common.sealedHeightQueryParam)
//
//		backend.Mock.
//			On("GetLatestBlockHeader", mocktestify.Anything, true).
//			Return(block, flow.BlockStatusSealed, nil)
...
//		block := unittest.BlockHeaderFixture(unittest.WithHeaderHeight(height))
//
//		req := getAccountKeysRequest(t, account, common.finalHeightQueryParam)
//
//		backend.Mock.
//			On("GetLatestBlockHeader", mocktestify.Anything, false).
//			Return(block, flow.BlockStatusFinalized, nil)
