...
//
//		req := scriptReq("", common.sealedHeightQueryParam, validBody)
//		common.assertOKResponse(t, req, fmt.Sprintf(
//			"\"%s\"",
...
//			common.assertResponse(t, req, http.StatusBadRequest, test.out, backend)
//		}
//	})
//}
