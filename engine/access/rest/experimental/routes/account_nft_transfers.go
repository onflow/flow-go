...
func GetAccountNonFungibleTokenTransfers(r *common.Request, backend extended.API, link commonmodels.LinkGenerator) (interface{}, error) {
	...
	page, err := backend.GetAccountNonFungibleTokenTransfers(r.Context(), req.Address, req.Limit, req.Cursor, req.Filter, expandFields, entities.EventEncodingVersion_JSON_CDC_V0)
	if err != nil {
		return nil, err
	}
