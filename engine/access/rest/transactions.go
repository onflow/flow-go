...
func GetTransactionByID(r *request.Request, srv RestServerApi, link models.LinkGenerator) (interface{}, error) {
...
func GetTransactionResultByID(r *request.Request, srv RestServerApi, link models.LinkGenerator) (interface{}, error) {
...
func CreateTransaction(r *request.Request, srv RestServerApi, link models.LinkGenerator) (interface{}, error) {
