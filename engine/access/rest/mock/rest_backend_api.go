...
// RestBackendApi is an autogenerated mock type for the RestBackendApi type
type RestBackendApi struct {
	mock.Mock
}

// ExecuteScriptAtBlockHeight provides a mock function with given fields: ctx, blockHeight, script, arguments
func (_m *RestBackendApi) ExecuteScriptAtBlockHeight(ctx context.Context, blockHeight uint64, script []byte, arguments [][]byte) ([]byte, error) {
...
func (_m *RestBackendApi) ExecuteScriptAtBlockID(ctx context.Context, blockID flow.Identifier, script []byte, arguments [][]byte) ([]byte, error) {
...
func (_m *RestBackendApi) ExecuteScriptAtLatestBlock(ctx context.Context, script []byte, arguments [][]byte) ([]byte, error) {
...
func (_m *RestBackendApi) GetAccountAtBlockHeight(ctx context.Context, address flow.Address, height uint64) (*flow.Account, error) {
...
func (_m *RestBackendApi) GetBlockByHeight(ctx context.Context, height uint64) (*flow.Block, flow.BlockStatus, error) {
...
func (_m *RestBackendApi) GetBlockByID(ctx context.Context, id flow.Identifier) (*flow.Block, flow.BlockStatus, error) {
...
func (_m *RestBackendApi) GetCollectionByID(ctx context.Context, id flow.Identifier) (*flow.LightCollection, error) {
	ret := _m.Called(ctx, id)
...
func (_m *RestBackendApi) GetEventsForBlockIDs(ctx context.Context, eventType string, blockIDs []flow.Identifier) ([]flow.BlockEvents, error) {
...
func (_m *RestBackendApi) GetEventsForHeightRange(ctx context.Context, eventType string, startHeight uint64, endHeight uint64) ([]flow.BlockEvents, error) {
...
func (_m *RestBackendApi) GetExecutionResultByID(ctx context.Context, id flow.Identifier) (*flow.ExecutionResult, error) {
	ret := _m.Called(ctx, id)
...
func (_m *RestBackendApi) GetExecutionResultForBlockID(ctx context.Context, blockID flow.Identifier) (*flow.ExecutionResult, error) {
...
func (_m *RestBackendApi) GetLatestBlock(ctx context.Context, isSealed bool) (*flow.Block, flow.BlockStatus, error) {
...
func (_m *RestBackendApi) GetLatestBlockHeader(ctx context.Context, isSealed bool) (*flow.Header, flow.BlockStatus, error) {
	ret := _m.Called(ctx, isSealed)
...
func (_m *RestBackendApi) GetNetworkParameters(ctx context.Context) access.NetworkParameters {
	ret := _m.Called(ctx)
...
func (_m *RestBackendApi) GetNodeVersionInfo(ctx context.Context) (*access.NodeVersionInfo, error) {
	ret := _m.Called(ctx)
...
func (_m *RestBackendApi) GetTransaction(ctx context.Context, id flow.Identifier) (*flow.TransactionBody, error) {
	ret := _m.Called(ctx, id)
...
func (_m *RestBackendApi) GetTransactionResult(ctx context.Context, id flow.Identifier, blockID flow.Identifier, collectionID flow.Identifier) (*access.TransactionResult, error) {
...
func (_m *RestBackendApi) SendTransaction(ctx context.Context, tx *flow.TransactionBody) error {
...
type mockConstructorTestingTNewRestBackendApi interface {
	mock.TestingT
	Cleanup(func())
}

// NewRestBackendApi creates a new instance of RestBackendApi. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewRestBackendApi(t mockConstructorTestingTNewRestBackendApi) *RestBackendApi {
	mock := &RestBackendApi{}
	mock.Mock.Test(t)
