...
func (_m *API) SubscribeAccountStatusesFromLatestBlock(ctx context.Context, filter state_stream.AccountStatusFilter) subscription.Subscription[*state_stream.AccountStatusesResponse] {
...
func (_m *API) SubscribeAccountStatusesFromStartBlockID(ctx context.Context, startBlockID flow.Identifier, filter state_stream.AccountStatusFilter) subscription.Subscription[*state_stream.AccountStatusesResponse] {
...
func (_m *API) SubscribeAccountStatusesFromStartHeight(ctx context.Context, startHeight uint64, filter state_stream.AccountStatusFilter) subscription.Subscription[*state_stream.AccountStatusesResponse] {
...
func (_m *API) SubscribeEvents(ctx context.Context, startBlockID flow.Identifier, startHeight uint64, filter state_stream.EventFilter) subscription.Subscription[*state_stream.EventsResponse] {
...
func (_m *API) SubscribeEventsFromLatest(ctx context.Context, filter state_stream.EventFilter) subscription.Subscription[*state_stream.EventsResponse] {
	ret := _m.Called(ctx, filter)
...
func (_m *API) SubscribeEventsFromStartBlockID(ctx context.Context, startBlockID flow.Identifier, filter state_stream.EventFilter) subscription.Subscription[*state_stream.EventsResponse] {
	ret := _m.Called(ctx, startBlockID, filter)
...
func (_m *API) SubscribeEventsFromStartHeight(ctx context.Context, startHeight uint64, filter state_stream.EventFilter) subscription.Subscription[*state_stream.EventsResponse] {
	ret := _m.Called(ctx, startHeight, filter)
...
func (_m *API) SubscribeExecutionData(ctx context.Context, startBlockID flow.Identifier, startBlockHeight uint64) subscription.Subscription[*state_stream.ExecutionDataResponse] {
...
func (_m *API) SubscribeExecutionDataFromLatest(ctx context.Context) subscription.Subscription[*state_stream.ExecutionDataResponse] {
	ret := _m.Called(ctx)
...
func (_m *API) SubscribeExecutionDataFromStartBlockHeight(ctx context.Context, startBlockHeight uint64) subscription.Subscription[*state_stream.ExecutionDataResponse] {
...
func (_m *API) SubscribeExecutionDataFromStartBlockID(ctx context.Context, startBlockID flow.Identifier) subscription.Subscription[*state_stream.ExecutionDataResponse] {
