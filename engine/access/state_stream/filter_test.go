...
func TestFilter(t *testing.T) {
	...
	events := flow.EventsList{
		unittest.EventFixture("A.0000000000000001.Contract1.EventA", 0, 0, unittest.IdentifierFixture()),
		unittest.EventFixture("A.0000000000000001.Contract2.EventA", 0, 0, unittest.IdentifierFixture()),
		unittest.EventFixture("flow.AccountCreated", 0, 0, unittest.IdentifierFixture()),
	}
