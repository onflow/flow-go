...
type Mempool interface {
	...
	GetExecutionResult(fingerprint flow.Fingerprint) (*flow.ExecutionResult, error)
	...
	GetExecutionReceipts(fingerprint flow.Fingerprint) (map[string]*flow.ExecutionReceipt, error)
	...
	ReceiptsCount(fingerprint flow.Fingerprint) int
