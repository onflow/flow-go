...
type Mempool interface {
	...
	Put(receipt *flow.ExecutionReceipt)
	...
	GetExecutionResult(hash crypto.Hash) (*flow.ExecutionResult, error)
	...
	GetExecutionReceipts(hash crypto.Hash) ([]flow.ExecutionReceipt, error)
