...
// NewChunkDataPackRequester creates a new instance of ChunkDataPackRequester. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewChunkDataPackRequester(t testing.TB) *ChunkDataPackRequester {
