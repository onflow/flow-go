...
// NewChunkDataPackHandler creates a new instance of ChunkDataPackHandler. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewChunkDataPackHandler(t testing.TB) *ChunkDataPackHandler {
