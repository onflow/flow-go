...
// NewEpochComponentsFactory creates a new instance of EpochComponentsFactory. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewEpochComponentsFactory(t testing.TB) *EpochComponentsFactory {
