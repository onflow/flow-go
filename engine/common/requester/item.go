...
type Item struct {
	EntityID           flow.Identifier                    // the key used to identify the requested entity (content hash or secondary key)
	...
	queryByContentHash bool                               // whether EntityID is the content hash of the requested entity
}
