...
func (ss *SyncSuite) TestPollHeight() {
	...
	ss.con.On("Multicast", mock.Anything, uint(3), others[0].NodeID, others[1].NodeID).Return(nil).Run(
		func(args mock.Arguments) {
...
func (ss *SyncSuite) TestSendRequests() {
	...
	ss.con.On("Multicast", mock.AnythingOfType("*messages.RangeRequest"), uint(3), mock.Anything, mock.Anything).Return(nil).Run(
		func(args mock.Arguments) {
	...
	ss.con.On("Multicast", mock.AnythingOfType("*messages.BatchRequest"), uint(3), mock.Anything, mock.Anything, mock.Anything).Return(nil).Run(
		func(args mock.Arguments) {
